...
from zenml.datasources import TFRecordsDatasource
...
try:
    ds = TFRecordsDatasource(name='coco_2017', path='/home/hamza/workspace/maiot/github_temp/zenml/.zenml/data/coco/coco/2017/1.1.0')
except AlreadyExistsException:
    ds = Repository.get_instance().get_datasource_by_name('coco_2017')
