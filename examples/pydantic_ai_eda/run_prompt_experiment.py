...
def main():
    ...
    print(
        f"📊 Testing {len(prompt_variants)} prompt variants on: {source_config.source_path}"
    )
    print(
        "This will help identify the best performing prompt for your use case.\n"
    )
        ...
        try:
            ...
            if "compare_agent_prompts" in step_names:
                ...
                if "prompt_comparison_results" in outputs:
                    ...
                    print(
                        f"✅ Successful runs: {summary['successful_runs']}/{summary['total_prompts_tested']}"
                    )
