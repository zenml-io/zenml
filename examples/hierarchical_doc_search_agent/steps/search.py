...
def _load_documents() -> Dict[str, Any]:
    ...
    continuing to fallback paths on failure. Results are cached since the
    document graph is static during pipeline execution.
    """
    search_paths = [
...
def traverse_node(
    ...
    result_dict = {
        ...
        "answer": _truncate_text(decision.answer, MAX_ANSWER_CHARS),
        "reasoning": _truncate_text(decision.reasoning, 2000),
        "visited": visited,
        "budget": budget - 1,
    }
