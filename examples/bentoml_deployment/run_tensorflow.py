...
def main(
    ...
    deployer_step_name = "bentoml_model_deployer_step"
    ...
    if deploy:
        ...
        deployment = tensorflow_training_deployment_pipeline(
            ...
            model_deployer=bentoml_tensorflow_deployer,
        )
    ...
    if services:
        service = cast(BentoMLDeploymentService, services[0])
        if service.is_running:
            print(
                f"The BentoML prediction server is running remotely as a Kubernetes "
            ...
            print(
                f"The BentoML prediction server is in a failed state:\n"
        ...
        print(
            "No BentoML prediction server is currently running. The deployment "
