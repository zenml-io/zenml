...
"""Shared data loading utilities for the hyperparameter tuning example."""
...
def get_fashion_mnist_loaders(
    ...
    # Multiple parallel trials may call this simultaneously; a file lock
    # prevents concurrent downloads from corrupting the cached dataset.
