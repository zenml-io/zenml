...
def demo_simple_prompt_comparison():
    ...
    prompt_v1 = Prompt(template="Answer: {question}", version="1.0.0")
    ...
    print("\n🏆 COMPARISON RESULTS")
    print(
        f"Winner: Prompt v{result['winner']} ({result['prompt_a_version'] if result['winner'] == 'A' else result['prompt_b_version']})"
    )
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n💡 In real usage:")
        print("   • Test cases would be real user scenarios")
        print("   • Metric function would evaluate LLM responses")
        print("   • Results would show in ZenML dashboard")
