...
assert GCP_PROJECT
assert GCP_REGION
assert GCP_CLOUD_SQL_INSTANCE_NAME
assert MYSQL_DB
assert MYSQL_USER
assert MYSQL_PWD

CONNECTION_NAME = f'{GCP_PROJECT}:{GCP_PROJECT}:{GCP_CLOUD_SQL_INSTANCE_NAME}'
...
artifact_store = ArtifactStore(
    os.path.join(GCP_BUCKET, 'vm_orchestrator/artifact_store'))
