...
from zenml import Model, get_step_context, step, ArtifactConfig
...
def compute_performance_metrics_on_current_data(
    ...
    Annotated[float, ArtifactConfig(name="latest_metric", tags=["c1"])],
    Annotated[float, ArtifactConfig(name="current_metric", tags=["c1"])]
]:
