...
@step
def promote_metric_compare_promoter_in_model_registry(
    latest_metric: float,
    current_metric: float,
    latest_version: str,
    current_version: str,
) -> Tuple[
    Annotated[bool, "was_promoted"], Annotated[int, "promoted_version"]
]:
    ...
    ### YOUR CODE ENDS HERE ###
    return should_promote, int(promoted_version)
