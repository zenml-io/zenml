...
class TestPipelineServingService:
    ...
    def test_execute_with_orchestrator(
        ...
        with (
            ...
            patch(
                "zenml.deployers.serving.service.runtime.start"
            ) as mock_start,
            patch("zenml.deployers.serving.service.runtime.stop") as mock_stop,
            patch(
                "zenml.deployers.serving.service.runtime.is_active",
                return_value=True,
            ) as mock_is_active,
            patch(
                "zenml.deployers.serving.service.runtime.get_outputs",
    ...
    @patch("zenml.deployers.serving.service.load_and_run_hook")
