...
def test_singleton_classes_only_create_one_instance():
    """Tests that a class with metaclass `SingletonMetaClass` only creates
    one instance."""
...
def test_singleton_metaclass_can_be_used_for_multiple_classes():
    """Tests that multiple classes can use the `SingletonMetaClass` and their
    instances don't get mixed up."""
