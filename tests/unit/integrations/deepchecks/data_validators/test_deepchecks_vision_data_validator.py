...
def test_deepchecks_data_validator_attributes():
    ...
    validator = DeepchecksVisionDataValidator(
        name="arias_validator",
        id=uuid4(),
        config={},
        flavor="deepchecks-vision",
    ...
    assert validator.flavor == DEEPCHECKS_VISION_DATA_VALIDATOR_FLAVOR
    assert validator.name == "arias_validator"
    assert validator.NAME == "Deepchecks Vision"
