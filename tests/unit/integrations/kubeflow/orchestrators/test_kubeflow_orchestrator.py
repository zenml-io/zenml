...
K8S_REMOTE_CONTEXT = "kubeflow_context"
...
def test_kubeflow_orchestrator_remote_stack(
    ...
    orchestrator = _get_kubeflow_orchestrator(K8S_REMOTE_CONTEXT)
    with does_not_raise():
        Stack(
            id=uuid4(),
            name="",
    ...
    orchestrator = _get_kubeflow_orchestrator(K8S_LOCAL_CONTEXT)
