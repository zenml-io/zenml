...
def test_path_materializer():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert (result / "test2.log").read_text() == "This is another test file"
        assert (result / "subdir" / "test3.py").read_text() == "print('Hello, world!')"
...
def test_path_materializer_metadata():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        expected_size = sum(f.stat().st_size for f in [test_file_1, test_file_2, test_file_3])
