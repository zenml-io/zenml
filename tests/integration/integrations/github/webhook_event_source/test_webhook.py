...
from zenml.integrations.github.plugins.event_sources.github_webhook_event_source import GithubWebhookEventSourceHandler
...
EXAMPLE_EVENT = correct_event = {
        ...
        "organization": {
            ...
            "members_url": "https://api.github.com/orgs/zenml-io/members{"
                           "/member}",
            "public_members_url":
                "https://api.github.com/orgs/zenml-io/public_members{/member}",
        ...
        "commits": [
            {
                ...
                "removed": [],
                "modified": [
                    "src/zenml/mouse-traps"
                    "/arias-personal-moustrap.py"
                ]
            }
        ],
    }
