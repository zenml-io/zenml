...
def test_artifact_list(clean_project_with_run):
...
def test_artifact_delete_fails_if_artifact_still_used(clean_project_with_run):
...
def test_artifact_prune(clean_project_with_run):
