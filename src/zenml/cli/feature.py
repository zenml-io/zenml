...
@click.pass_obj
def get_data_sources(feature_store: "FeastFeatureStore") -> None:
...
@click.pass_obj
def get_entities(feature_store: "FeastFeatureStore") -> None:
...
@click.pass_obj
def get_feature_services(feature_store: "FeastFeatureStore") -> None:
...
@click.pass_obj
def get_feature_views(feature_store: "FeastFeatureStore") -> None:
...
@click.pass_obj
def get_project(feature_store: "FeastFeatureStore") -> None:
...
@click.pass_obj
def get_feast_version(feature_store: "FeastFeatureStore") -> None:
