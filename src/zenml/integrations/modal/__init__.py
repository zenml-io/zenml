...
"""Modal integration for cloud-native execution.

The Modal integration sub-module provides step operator and sandbox flavors
that allow executing workloads on Modal infrastructure.
"""
