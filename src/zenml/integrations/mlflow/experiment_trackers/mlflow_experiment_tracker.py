...
class MLFlowExperimentTracker(BaseExperimentTracker):
    ...
    def disable_autologging_for_framework(self, framework: str) -> None:
        """Disables MLflow autologging for a specific framework.

        Args:
            framework: Name of the framework for which to disable autologging.
        """
        from mlflow import (
            fastai,
            gluon,
    ...
    def disable_autologging(self) -> None:
        ...
        # To ensure that possible missing underlying packages aren't causing issues, we
        # capture the import errors and log them as warnings.

        self.disable_autologging_for_framework("tensorflow")
        self.disable_autologging_for_framework("gluon")
        self.disable_autologging_for_framework("xgboost")
        self.disable_autologging_for_framework("lightgbm")
        self.disable_autologging_for_framework("statsmodels")
