...
class SagemakerOrchestratorSettings(BaseSettings):
    ...
    keep_alive_period_in_seconds: int | None = Field(
        300,  # 5 minutes
    ...
    use_training_step: bool | None = Field(
        None,
    ...
    output_data_s3_uri: str | dict[str, str] | None = Field(
        default=None,
        union_mode="left_to_right",
...
class SagemakerOrchestratorConfig(
    ...
    aws_access_key_id: str | None = SecretField(
        default=None,
    ...
    aws_secret_access_key: str | None = SecretField(
        default=None,
    ...
    aws_auth_role_arn: str | None = Field(
        None,
