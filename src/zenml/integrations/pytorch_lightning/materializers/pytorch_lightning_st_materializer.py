...
"""Implementation of the PyTorch Lightning Materializer using Safetensors."""
...
CHECKPOINT_NAME = "final_checkpoint.safetensors"


class PyTorchLightningSTMaterializer(BasePyTorchSTMaterializer):
