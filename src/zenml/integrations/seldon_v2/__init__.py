...
from zenml.integrations.constants import SELDON_V2
from zenml.integrations.integration import Integration
from zenml.stack import Flavor

SELDON_V2_MODEL_DEPLOYER_FLAVOR = "seldon_v2"


class SeldonV2Integration(Integration):
    ...
    def activate(cls) -> None:
        """Activate the Seldon Core V2 integration."""
        from zenml.integrations.seldon import secret_schemas  # noqa
        from zenml.integrations.seldon_v2 import services  # noqa
    ...
    def flavors(cls) -> List[Type[Flavor]]:
        ...
        """
        from zenml.integrations.seldon_v2.flavors import (
            SeldonV2ModelDeployerFlavor,
        )

        return [SeldonV2ModelDeployerFlavor]


SeldonV2Integration.check_installation()
