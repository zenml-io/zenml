...
class SeldonS3SecretSchema(BaseSecretSchema):
    ...
    rclone_config_s3_access_key_id: str | None = None
    rclone_config_s3_secret_access_key: str | None = None
    rclone_config_s3_session_token: str | None = None
    rclone_config_s3_region: str | None = None
    rclone_config_s3_endpoint: str | None = None
...
class SeldonGSSecretSchema(BaseSecretSchema):
    ...
    rclone_config_gs_client_id: str | None = None
    rclone_config_gs_client_secret: str | None = None
    rclone_config_gs_project_number: str | None = None
    rclone_config_gs_service_account_credentials: str | None = None
    rclone_config_gs_anonymous: bool = False
    rclone_config_gs_token: str | None = None
    rclone_config_gs_auth_url: str | None = None
    rclone_config_gs_token_url: str | None = None
...
class SeldonAzureSecretSchema(BaseSecretSchema):
    ...
    rclone_config_az_account: str | None = None
    rclone_config_az_key: str | None = None
    rclone_config_az_sas_url: str | None = None
    rclone_config_az_use_msi: bool = False
    rclone_config_az_client_secret: str | None = None
    rclone_config_az_client_id: str | None = None
    rclone_config_az_tenant: str | None = None
