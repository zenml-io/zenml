...
def seldon_model_deployer_step(
    ...
    Args:
        ...
        timeout: timeout in seconds to wait for the deployment to start
    ...
    def prepare_service_config(model_uri: str) -> SeldonDeploymentConfig:
        ...
        service_config_copy.model_uri = served_model_uri
        return service_config_copy
...
def seldon_custom_model_deployer_step(
    ...
    if not custom_deploy_parameters:
        raise ValueError(
    ...
    entrypoint_command = [
        ...
        "--predict_func",
        custom_deploy_parameters.predict_function,
    ]
