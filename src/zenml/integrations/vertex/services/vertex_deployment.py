...
class VertexDeploymentEndpointConfig(ServiceEndpointConfig):
    """Vertex daemon service endpoint configuration.
...
class VertexDeploymentEndpoint(BaseServiceEndpoint):
    ...
    config: VertexDeploymentEndpointConfig
