...
from zenml.integrations.deepchecks import DeepchecksTabularIntegration  # noqa
from zenml.integrations.deepchecks import DeepchecksVisionIntegration  # noqa
from zenml.integrations.deepchecks import (
    DeprecatedDeepchecksIntegration,
)  # noqa
