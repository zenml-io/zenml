...
"""Implementation of the DVC Artifact Store."""
...
from zenml.integrations.dvc import DVC_ARTIFACT_STORE_FLAVOR
...
class DVCArtifactStore(LocalArtifactStore):
    """Artifact Store for DVC artifacts."""

    # Class Configuration
    FLAVOR: ClassVar[str] = DVC_ARTIFACT_STORE_FLAVOR
