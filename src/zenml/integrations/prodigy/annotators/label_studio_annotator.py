...
class LabelStudioAnnotator(BaseAnnotator, AuthenticationMixin):
    ...
    def _get_azure_import_storage_sources(
        ...
        Raises:
            ConnectionError: If the connection to the Prodigy backend is unavailable.
        """
    ...
    def get_parsed_label_config(self, dataset_id: int) -> Dict[str, Any]:
        """Returns the parsed Prodigy label config for a dataset.
    ...
    def populate_artifact_store_parameters(
        ...
        if artifact_store.flavor == "s3":
            ...
            raise RuntimeError(
                ...
                "store. The Prodigy annotator needs explicit credentials "
            ...
            if gcp_credentials:
                ...
                # Prodigy will need to read it from a file
                secret_folder = Path(
            ...
            if azure_credentials:
                ...
                raise RuntimeError(
                    "The Prodigy annotator could not use the "
        ...
        raise RuntimeError(
            ...
            "supported by ZenML's Prodigy integration. "
        ...
        if params.storage_type == "azure":
            if not params.azure_account_name or not params.azure_account_key:
                logger.warning(
                    ...
                    "settings in the Prodigy web UI as per your needs."
                )
            ...
            if not params.google_application_credentials:
                logger.warning(
                    ...
                    "synchronization settings in the Prodigy web UI as "
                    "per your needs."
                )
            ...
            if (
                ...
                logger.warning(
                    ...
                    "Prodigy web UI as per your needs."
                )
            ...
            # Set the environment variables required by Prodigy
            ...
            raise ValueError(
                ...
                "supported by ZenML's Prodigy integration. Please choose "
