...
"""Implementation of label config generators for Prodigy."""
...
def generate_text_classification_label_config(
    ...
    """Generates a Prodigy label config for text classification.
...
def generate_image_classification_label_config(
    ...
    """Generates a Prodigy label config for image classification.
...
def generate_basic_object_detection_bounding_boxes_label_config(
    ...
    """Generates a Prodigy config for object detection with bounding boxes.
...
def generate_basic_ocr_label_config(
    ...
    """Generates a Prodigy config for optical character recognition (OCR) labeling task.
