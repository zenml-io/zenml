...
class BaseActionHandler(BasePlugin, ABC):
    ...
    def _process_action_request(
        ...
        """Process a action request after it is created in the database.
    ...
    def _process_action_update(
        ...
        """Process a action after it is updated in the database.
    ...
    def _process_action_delete(
        ...
        """Process a action before it is deleted from the database.
