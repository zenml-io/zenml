...
def get_resource_type_for_model(
    ...
    mapping: Dict[
        ...
        PipelineSnapshotRequest: ResourceType.PIPELINE_DEPLOYMENT,
        PipelineSnapshotResponse: ResourceType.PIPELINE_DEPLOYMENT,
...
def get_schema_for_resource_type(
    ...
    mapping: Dict[ResourceType, Type["BaseSchema"]] = {
        ...
        ResourceType.PIPELINE_DEPLOYMENT: PipelineSnapshotSchema,
