...
class CostAssistantHandler(BaseAssistantHandler, ABC):
...
class CostAssistantFlavor(BaseAssistantFlavor):
    """Enables users to discover assistant handlers."""

    FLAVOR: ClassVar[str] = "cost_assistant"
    PLUGIN_CLASS: ClassVar[Type[CostAssistantHandler]] = (
        CostAssistantHandler
    )
