...
# Legacy fields on `PipelineConfiguration` that old clients use to store
# execution overrides. These are converted to `ExecutionOverrides` when a
# snapshot request is validated.
LEGACY_EXECUTION_OVERRIDE_FIELDS = (
    "steps_to_skip",
