...
class DockerSettings(BaseSettings):
    ...
    * `dockerfile` specified: ZenML will first build an image based on the
    ...
    Attributes:
        ...
        image_tag: [Optional] Docker image tag use for generated image.

            Additional notes:
            * This will override the default zenml tagging mechanism
            using step.name or pipeline.name
            * Make sure the tag you provide does not lead to image conflicts.
