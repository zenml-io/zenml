...
class ServiceConnectorRequest(UserScopedRequest):
    ...
    expires_skew_tolerance: int | None = Field(
        default=None,
...
class ServiceConnectorUpdate(BaseUpdate):
    ...
    * the `labels` field is also a full labels update: if set (i.e. not
    ...
    connector_type: Union[str, "ServiceConnectorTypeModel"] | None = Field(
        title="The type of service connector.",
        default=None,
        union_mode="left_to_right",
    )
    ...
    supports_instances: bool | None = Field(
        title="Indicates whether the connector instance can be used to access "
        "multiple instances of the configured resource type.",
        default=None,
    )
    ...
    configuration: ServiceConnectorConfiguration | None = Field(
...
class ServiceConnectorResponse(
    ...
    @property
    def expires_skew_tolerance(self) -> int | None:
...
class ServiceConnectorFilter(UserScopedFilter):
    ...
    labels: dict[str, str | None] | None = Field(
        default=None,
