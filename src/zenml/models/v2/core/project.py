...
class ProjectUpdate(BaseUpdate):
    ...
    retention: Optional[RetentionSettings] = Field(
        default=None, title="The execution retention policy for the project."
    )
...
class ProjectResponseMetadata(BaseResponseMetadata):
    ...
    retention: RetentionSettings = Field(
        ...
        title="The saved execution retention policy for the project.",
    )
...
class ProjectFilter(BaseFilter):
    ...
    display_name: StringFilterOption = Field(
        default=None,
