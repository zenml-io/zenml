...
def downgrade() -> None:
    ...
    with op.batch_alter_table("user_role_assignment", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            "fk_user_role_assignment_workspace_id_workspace", type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "fk_user_role_assignment_project_id_workspace",
            "workspace",
            ["project_id"],
            ["id"],
            ondelete="CASCADE",
    ...
    with op.batch_alter_table("team_role_assignment", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            "fk_team_role_assignment_workspace_id_workspace", type_="foreignkey"
        )
        batch_op.create_foreign_key(
            "fk_team_role_assignment_project_id_workspace",
            "workspace",
            ["project_id"],
            ["id"],
            ondelete="CASCADE",
    ...
    with op.batch_alter_table("stack_component", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "fk_stack_component_project_id_workspace",
            "workspace",
            ["project_id"],
            ["id"],
            ondelete="CASCADE",
    ...
    with op.batch_alter_table("pipeline_run", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "fk_pipeline_run_project_id_workspace",
            "workspace",
            ["project_id"],
            ["id"],
            ondelete="CASCADE",
    ...
    with op.batch_alter_table("pipeline", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "fk_pipeline_project_id_workspace",
            "workspace",
            ["project_id"],
            ["id"],
            ondelete="CASCADE",
    ...
    with op.batch_alter_table("flavor", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "fk_flavor_project_id_workspace",
            "workspace",
            ["project_id"],
            ["id"],
            ondelete="CASCADE",
