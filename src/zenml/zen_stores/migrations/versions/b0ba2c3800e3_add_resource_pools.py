...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created", sa.DateTime(), nullable=False),
        sa.Column("updated", sa.DateTime(), nullable=False),
        sa.Column("pool_id", sqlmodel.sql.sqltypes.GUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created", sa.DateTime(), nullable=False),
        sa.Column("updated", sa.DateTime(), nullable=False),
        sa.Column("policy_id", sqlmodel.sql.sqltypes.GUID(), nullable=False),
        sa.Column("key", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created", sa.DateTime(), nullable=False),
        sa.Column("updated", sa.DateTime(), nullable=False),
        sa.Column("component_id", sqlmodel.sql.sqltypes.GUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("claim_token", sqlmodel.sql.sqltypes.GUID(), nullable=True),
