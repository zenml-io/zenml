...
#     sa.Column('description', sa.String(length=16777215).with_variant(mysql.MEDIUMTEXT(), 'mysql'), nullable=True),
#     sa.Column('pipeline_configuration', sa.String(length=16777215).with_variant(mysql.MEDIUMTEXT(), 'mysql'), nullable=False),
#     sa.Column('client_environment', sa.TEXT(), nullable=False),
#     sa.Column('run_name_template', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
#     sa.Column('client_version', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
#     sa.Column('server_version', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
#     sa.Column('pipeline_version_hash', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
#     sa.Column('pipeline_spec', sa.String(length=16777215).with_variant(mysql.MEDIUMTEXT(), 'mysql'), nullable=True),
#     sa.Column('code_path', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
#     sa.Column('user_id', sqlmodel.sql.sqltypes.GUID(), nullable=True),
...
#     sa.Column('code_reference_id', sqlmodel.sql.sqltypes.GUID(), nullable=True),
#     sa.Column('source_snapshot_id', sqlmodel.sql.sqltypes.GUID(), nullable=True),
#     sa.Column('template_id', sqlmodel.sql.sqltypes.GUID(), nullable=True),
#     sa.Column('step_count', sa.Integer(), nullable=False),
#     sa.ForeignKeyConstraint(['build_id'], ['pipeline_build.id'], name='fk_pipeline_snapshot_build_id_pipeline_build', ondelete='SET NULL'),
#     sa.ForeignKeyConstraint(['code_reference_id'], ['code_reference.id'], name='fk_pipeline_snapshot_code_reference_id_code_reference', ondelete='SET NULL'),
#     sa.ForeignKeyConstraint(['pipeline_id'], ['pipeline.id'], name='fk_pipeline_snapshot_pipeline_id_pipeline', ondelete='CASCADE'),
#     sa.ForeignKeyConstraint(['project_id'], ['project.id'], name='fk_pipeline_snapshot_project_id_project', ondelete='CASCADE'),
#     sa.ForeignKeyConstraint(['schedule_id'], ['schedule.id'], name='fk_pipeline_snapshot_schedule_id_schedule', ondelete='SET NULL'),
#     sa.ForeignKeyConstraint(['stack_id'], ['stack.id'], name='fk_pipeline_snapshot_stack_id_stack', ondelete='SET NULL'),
#     sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fk_pipeline_snapshot_user_id_user', ondelete='SET NULL'),
#     sa.PrimaryKeyConstraint('id'),
#     sa.UniqueConstraint('pipeline_id', 'version', name='unique_version_for_pipeline_id')
#     )

#     with op.batch_alter_table('pipeline_run', schema=None) as batch_op:
#         batch_op.add_column(sa.Column('snapshot_id', sqlmodel.sql.sqltypes.GUID(), nullable=True))
#         batch_op.drop_constraint('unique_orchestrator_run_id_for_deployment_id', type_='unique')
#         batch_op.create_unique_constraint('unique_orchestrator_run_id_for_snapshot_id', ['snapshot_id', 'orchestrator_run_id'])
#         batch_op.drop_constraint('fk_pipeline_run_deployment_id_pipeline_deployment', type_='foreignkey')
#         batch_op.create_foreign_key('fk_pipeline_run_snapshot_id_pipeline_snapshot', 'pipeline_snapshot', ['snapshot_id'], ['id'], ondelete='CASCADE')
#         batch_op.drop_column('deployment_id')

#     with op.batch_alter_table('run_template', schema=None) as batch_op:
#         batch_op.add_column(sa.Column('source_snapshot_id', sqlmodel.sql.sqltypes.GUID(), nullable=True))
#         batch_op.drop_constraint('fk_run_template_source_deployment_id_pipeline_deployment', type_='foreignkey')
#         batch_op.create_foreign_key('fk_run_template_source_snapshot_id_pipeline_snapshot', 'pipeline_snapshot', ['source_snapshot_id'], ['id'], ondelete='SET NULL')
#         batch_op.drop_column('source_deployment_id')

#     with op.batch_alter_table('step_configuration', schema=None) as batch_op:
#         batch_op.add_column(sa.Column('snapshot_id', sqlmodel.sql.sqltypes.GUID(), nullable=False))
#         batch_op.drop_constraint('unique_step_name_for_deployment', type_='unique')
#         batch_op.create_unique_constraint('unique_step_name_for_snapshot', ['snapshot_id', 'name'])
#         batch_op.drop_constraint('fk_step_configuration_deployment_id_pipeline_deployment', type_='foreignkey')
#         batch_op.create_foreign_key('fk_step_configuration_snapshot_id_pipeline_snapshot', 'pipeline_snapshot', ['snapshot_id'], ['id'], ondelete='CASCADE')
#         batch_op.drop_column('deployment_id')

#     with op.batch_alter_table('step_run', schema=None) as batch_op:
#         batch_op.add_column(sa.Column('snapshot_id', sqlmodel.sql.sqltypes.GUID(), nullable=True))
#         batch_op.drop_constraint('fk_step_run_deployment_id_pipeline_deployment', type_='foreignkey')
#         batch_op.create_foreign_key('fk_step_run_snapshot_id_pipeline_snapshot', 'pipeline_snapshot', ['snapshot_id'], ['id'], ondelete='CASCADE')
#         batch_op.drop_column('deployment_id')

#     with op.batch_alter_table('trigger_execution', schema=None) as batch_op:
#         batch_op.add_column(sa.Column('project_id', sqlmodel.sql.sqltypes.GUID(), nullable=False))
#         batch_op.add_column(sa.Column('user_id', sqlmodel.sql.sqltypes.GUID(), nullable=True))
#         batch_op.add_column(sa.Column('step_run_id', sqlmodel.sql.sqltypes.GUID(), nullable=True))
#         batch_op.alter_column('trigger_id',
#                existing_type=sa.CHAR(length=32),
#                nullable=True)
#         batch_op.create_foreign_key('fk_trigger_execution_user_id_user', 'user', ['user_id'], ['id'], ondelete='SET NULL')
#         batch_op.create_foreign_key('fk_trigger_execution_project_id_project', 'project', ['project_id'], ['id'], ondelete='CASCADE')
#         batch_op.create_foreign_key('fk_trigger_execution_step_run_id_step_run', 'step_run', ['step_run_id'], ['id'], ondelete='CASCADE')
