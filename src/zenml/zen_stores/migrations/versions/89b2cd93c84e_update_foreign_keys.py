"""Update foreign keys [89b2cd93c84e].

Revision ID: 89b2cd93c84e
Revises: 5330ba58bf20
Create Date: 2022-11-04 16:36:10.125360
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("artifacts", schema=None) as batch_op:
        batch_op.alter_column(
            "parent_step_id", existing_type=sa.CHAR(length=32), nullable=True
        )
        batch_op.alter_column(
            "producer_step_id", existing_type=sa.CHAR(length=32), nullable=True
        )
    ...
    with op.batch_alter_table("step_run", schema=None) as batch_op:
        batch_op.alter_column(
            "pipeline_run_id", existing_type=sa.CHAR(length=32), nullable=True
        )
        batch_op.drop_constraint(
    ...
    with op.batch_alter_table("team_role_assignment", schema=None) as batch_op:
        batch_op.alter_column(
            "role_id", existing_type=sa.CHAR(length=32), nullable=True
        )
        batch_op.alter_column(
            "team_id", existing_type=sa.CHAR(length=32), nullable=True
        )
        batch_op.drop_constraint(
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("user_role_assignment", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "role_id", existing_type=sa.CHAR(length=32), nullable=False
        )
    ...
    with op.batch_alter_table("team_role_assignment", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "team_id", existing_type=sa.CHAR(length=32), nullable=False
        )
        batch_op.alter_column(
            "role_id", existing_type=sa.CHAR(length=32), nullable=False
        )
    ...
    with op.batch_alter_table("artifacts", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "producer_step_id", existing_type=sa.CHAR(length=32), nullable=False
        )
        batch_op.alter_column(
            "parent_step_id", existing_type=sa.CHAR(length=32), nullable=False
        )
