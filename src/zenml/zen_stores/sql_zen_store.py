...
class SqlZenStore(BaseZenStore):
    ...
    def create_model_version(
        ...
        Raises:
            ...
            EntityExistsError: If a workspace with the given name already
                exists.
        """
    ...
    def update_model_version(
        ...
        Raises:
            ...
            RuntimeError: If there is a model version with target stage, but
                `force` flag is off.
        """
        with Session(self.engine) as session:
            existing_model_version = session.exec(
    ...
    def create_model_version_artifact_link(
        ...
        Args:
            model_version_artifact_link: the Model Version to Artifact Link to
                be created.
