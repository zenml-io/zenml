...
ENV_ZENML_ARTIFACT_UPLOAD_WORKER_COUNT = "ZENML_ARTIFACT_UPLOAD_WORKER_COUNT"
ENV_ZENML_ARTIFACT_UPLOAD_WAIT_TIMEOUT = "ZENML_ARTIFACT_UPLOAD_WAIT_TIMEOUT"
# Maximum size (in bytes) of the artifact staging directory. Once the limit
# is reached, output artifacts are uploaded synchronously instead. 0 means
# unlimited.
ENV_ZENML_ARTIFACT_STAGING_MAX_SIZE = "ZENML_ARTIFACT_STAGING_MAX_SIZE"
# Interval (in seconds) at which staged artifacts are uploaded. 0 means
# staged artifacts are uploaded immediately.
ENV_ZENML_ARTIFACT_UPLOAD_INTERVAL = "ZENML_ARTIFACT_UPLOAD_INTERVAL"
...
UNMATERIALIZED_ARTIFACT_URI_PREFIX = "unmaterialized://"
