...
ENV_ZENML_LOGS_ENTRIES_API_MAX_LIMIT = "ZENML_LOGS_ENTRIES_API_MAX_LIMIT"
...
LOGS_ENTRIES_API_MAX_LIMIT = handle_int_env_var(
    ENV_ZENML_LOGS_ENTRIES_API_MAX_LIMIT, default=10000
)

# OpenTelemetry log storage constants
ENV_ZENML_LOGS_OTEL_MAX_QUEUE_SIZE = "ZENML_LOGS_OTEL_MAX_QUEUE_SIZE"
ENV_ZENML_LOGS_OTEL_DEFAULT_QUERY_SIZE = "ZENML_LOGS_OTEL_DEFAULT_QUERY_SIZE"
...
LOGS_OTEL_DEFAULT_QUERY_SIZE = handle_int_env_var(
    ENV_ZENML_LOGS_OTEL_DEFAULT_QUERY_SIZE, default=1000
)
