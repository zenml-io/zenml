...
# Hard limit applied while decoding a single archive object. This bounds both
# ordinary oversized objects and decompression bombs before model validation.
DEFAULT_ZENML_SERVER_EXECUTION_ARCHIVE_MAX_DECODED_BYTES = (
    128 * 1024 * 1024  # 128 MiB
)
# A cold-authority switch locks the complete execution tree. Keep this
# deliberately conservative until production-shaped MySQL rehearsals justify
# a higher bound; oversized trees remain hot and fully usable.
DEFAULT_ZENML_SERVER_EXECUTION_ARCHIVE_MAX_ROWS = 10_000
MAX_ZENML_SERVER_EXECUTION_ARCHIVE_ERROR_LENGTH = 4096
DEFAULT_ZENML_SERVER_EXECUTION_ARCHIVE_COORDINATOR_INTERVAL = 60 * 60
DEFAULT_ZENML_SERVER_EXECUTION_ARCHIVE_SCAN_LIMIT = 100
MAX_ZENML_SERVER_EXECUTION_ARCHIVE_SCAN_LIMIT = 1000
DEFAULT_ZENML_SERVER_EXECUTION_ARCHIVE_WORK_LIMIT = 10
MAX_ZENML_SERVER_EXECUTION_ARCHIVE_WORK_LIMIT = 100
DEFAULT_ZENML_SERVER_EXECUTION_ARCHIVE_TIME_BUDGET = 5 * 60
MAX_ZENML_SERVER_EXECUTION_ARCHIVE_TIME_BUDGET = 60 * 60
DEFAULT_ZENML_SERVER_EXECUTION_ARCHIVE_LEASE_SECONDS = 15 * 60
MAX_ZENML_SERVER_EXECUTION_ARCHIVE_LEASE_SECONDS = 24 * 60 * 60
