...
# ZenML Server settings default values
ENV_ZENML_DEFAULT_SERVER_NAME = "ZENML_DEFAULT_SERVER_NAME"
ENV_ZENML_DEFAULT_DISPLAY_ANNOUNCEMENTS = "ZENML_DEFAULT_DISPLAY_ANNOUNCEMENTS"
ENV_ZENML_DEFAULT_DISPLAY_UPDATES = "ZENML_DEFAULT_DISPLAY_UPDATES"

DEFAULT_SERVER_NAME = os.environ.get(ENV_ZENML_DEFAULT_SERVER_NAME, "default")
DEFAULT_DISPLAY_ANNOUNCEMENTS = handle_bool_env_var(
    ENV_ZENML_DEFAULT_DISPLAY_ANNOUNCEMENTS, default=False
)
DEFAULT_DISPLAY_UPDATES = handle_bool_env_var(
    ENV_ZENML_DEFAULT_DISPLAY_UPDATES, default=False
)
