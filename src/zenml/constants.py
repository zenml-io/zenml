...
ENV_ZENML_DEFAULT_SERVER_NAME = "ENV_ZENML_DEFAULT_SERVER_NAME"
ENV_ZENML_DEFAULT_DISPLAY_WHATS_NEW = "ENV_ZENML_DEFAULT_DISPLAY_WHATS_NEW"
ENV_ZENML_DEFAULT_DISPLAY_USER_SURVEYS = (
    "ENV_ZENML_DEFAULT_DISPLAY_USER_SURVEYS"
)

DEFAULT_SERVER_NAME = os.environ.get(ENV_ZENML_DEFAULT_SERVER_NAME, "default")
DEFAULT_DISPLAY_WHATS_NEW = handle_bool_env_var(
    ENV_ZENML_DEFAULT_DISPLAY_WHATS_NEW, default=False
)
DEFAULT_DISPLAY_USER_SURVEYS = handle_bool_env_var(
    ENV_ZENML_DEFAULT_DISPLAY_USER_SURVEYS, default=False
)
