...
ENV_ZENML_MATERIALIZER_COLLECTION_CHUNK_SIZE = (
    "ZENML_MATERIALIZER_COLLECTION_CHUNK_SIZE"
)
...
DEFAULT_COLLECTION_CHUNK_SIZE = handle_int_env_var(
    ENV_ZENML_MATERIALIZER_COLLECTION_CHUNK_SIZE, default=100
)  # number of elements per chunk for collection materializers
