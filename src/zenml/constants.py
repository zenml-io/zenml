...
ENV_ZENML_LOGS_OTEL_MAX_QUERY_SIZE = "ZENML_LOGS_OTEL_MAX_QUERY_SIZE"
...
LOGS_OTEL_MAX_QUERY_SIZE = handle_int_env_var(
    ENV_ZENML_LOGS_OTEL_MAX_QUERY_SIZE, default=1000
)
