...
DOCSTRING_SRC=${1:-"src/zenml/alerter src/zenml/artifact_stores src/zenml/artifacts src/zenml/config src/zenml/io src/zenml/model_deployers src/zenml/cli src/zenml/entrypoints src/zenml/experiment_trackers src/zenml/orchestrators src/zenml/pipelines src/zenml/post_execution src/zenml/secret"}
