...
VERSIONS=("0.40.0" "0.40.3" "0.41.0" "0.43.0" "0.44.1" "0.44.3" "0.45.2" "0.45.3" "0.45.4" "0.45.5" "0.45.6" "0.46.0" "0.47.0" "0.50.0" "0.51.0" "0.52.0" "0.53.0" "0.53.1" "0.54.0" "0.54.1" "0.55.0" "0.55.1" "0.55.2" "0.55.3" "0.55.4" "0.55.5" "0.56.2" "0.56.3" "0.56.4" "0.57.0" "0.57.1" "0.58.0" "0.58.1" "0.58.2" "0.60.0" "0.61.0" "0.62.0" "0.63.0" "0.64.0" "0.65.0")
...
function run_tests_for_version() {
    ...
    if [ "$(version_compare "$VERSION" "0.65.0")" == "<" ]; then
