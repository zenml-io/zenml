...
daily_users = ['daily_user_0', 'daily_user_1', 'daily_user_2', 'daily_user_3',
               'daily_user_4', 'daily_user_5', 'daily_user_6', 'daily_user_7',
               'daily_user_8', 'daily_user_9', 'daily_user_10', 'daily_user_11',
               'daily_user_12', 'daily_user_13', 'daily_user_14',
               'daily_user_15', 'daily_user_16', 'daily_user_17',
               'daily_user_18', 'daily_user_19']

weekly_users = ['weekly_user_0', 'weekly_user_1', 'weekly_user_2',
                'weekly_user_3', 'weekly_user_4', 'weekly_user_5',
                'weekly_user_6', 'weekly_user_7', 'weekly_user_8',
                'weekly_user_9', 'weekly_user_10', 'weekly_user_11',
                'weekly_user_12', 'weekly_user_13', 'weekly_user_14']
...
days_since_epoch = (
        datetime.datetime.now() - datetime.datetime(1970, 1, 1)).days
