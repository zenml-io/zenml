...
wrapper_factory.register_metadata_wrapper(
    SQLiteMetadataStore.STORE_TYPE, SQLiteMetadataStore
)
wrapper_factory.register_metadata_wrapper(
    MySQLMetadataStore.STORE_TYPE, MySQLMetadataStore
)
wrapper_factory.register_metadata_wrapper(
    MockMetadataStore.STORE_TYPE, MockMetadataStore
)
