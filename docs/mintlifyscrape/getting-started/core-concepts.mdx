...
[**1\. Development**As a developer, how do I design my machine learning workflows?](/getting-started/core-concepts#1-development)[**2\. Execution**While executing, how do my workflows utilize the large landscape of MLOps tooling/infrastructure?](/getting-started/core-concepts#2-execution)[**3\. Management**How do I establish and maintain a production-grade and efficient solution?](/getting-started/core-concepts#3-management)
...
![](/images/getting-started/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-ce13142154e9dc562c10c029680c77b543265b64%252F01_pipeline.png)
...
The serialization and deserialization logic of artifacts is defined by [Materializers](/how-to/handle-data-artifacts/handle-custom-data-types).
...
![](/images/getting-started/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-506972ee9e2ae0618aa74e36e95f5b9d725379e0%252F02_pipeline_local_stack.png)
...
To use _stack components_ that are running remotely on a cloud infrastructure, you need to deploy a [**ZenML Server**](/user-guide/production-guide/deploying-zenml) so it can communicate with these stack components and run your pipelines. The server is also responsible for managing ZenML business entities like pipelines, steps, models, etc.

![](/images/getting-started/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-ae8a72912c75c05d0e7df012699f11dae0e487f4%252F04_architecture.png)

Visualization of the relationship between code and infrastructure.

#### Server Deployment

In order to benefit from the advantages of using a deployed ZenML server, you can either choose to use the [**ZenML Pro SaaS offering**](/getting-started/zenml-pro/zenml-pro) which provides a control plane for you to create managed instances of ZenML servers, or [deploy it in your self-hosted environment](/getting-started/deploying-zenml).
...
The **ZenML Server** also acts as a [centralized secrets store](/getting-started/deploying-zenml/secret-management) that safely and securely stores sensitive data such as credentials used to access the services that are part of your stack. It can be configured to use a variety of different backends for this purpose, such as the AWS Secrets Manager, GCP Secret Manager, Azure Key Vault, and Hashicorp Vault.

Secrets are sensitive data that you don't want to store in your code or configure alongside your stacks and pipelines. ZenML includes a [centralized secrets store](/getting-started/deploying-zenml/secret-management) that you can use to store and access your secrets securely.
...
When you start working with ZenML, you'll start with a local ZenML setup, and when you want to transition you will need to [deploy ZenML](/getting-started/deploying-zenml). Don't worry though, there is a one-click way to do it which we'll learn about later.
