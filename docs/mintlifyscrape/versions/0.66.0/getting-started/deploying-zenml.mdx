...
<CardGroup cols={2}>
  <Card
    ...
    icon="terminal"
    href="https://docs.zenml.io/versions/0.66.0/getting-started/deploying-zenml/deploy-with-zenml-cli"
    horizontal
  >
  ...
  <Card
    ...
    icon="docker"
    href="https://docs.zenml.io/versions/0.66.0/getting-started/deploying-zenml/deploy-with-docker"
    horizontal
  >
  ...
  <Card
    ...
    icon="face-smile"
    href="https://docs.zenml.io/versions/0.66.0/getting-started/deploying-zenml/deploy-with-helm"
    horizontal
  >
  ...
  <Card
    ...
    href="https://docs.zenml.io/versions/0.66.0/getting-started/deploying-zenml/deploy-using-huggingface-spaces"
    horizontal
  >
