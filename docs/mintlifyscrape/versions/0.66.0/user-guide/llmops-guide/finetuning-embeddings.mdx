...
* [generating synthetic data with distilabel](/versions/0.66.0/user-guide/llmops-guide/finetuning-embeddings/synthetic-data-generation)
* [finetuning embeddings with Sentence Transformers](/versions/0.66.0/user-guide/llmops-guide/finetuning-embeddings/finetuning-embeddings-with-sentence-transformers)
* [evaluating finetuned embeddings and using ZenML's model control plane to get a systematic overview](/versions/0.66.0/user-guide/llmops-guide/finetuning-embeddings/evaluating-finetuned-embeddings)
