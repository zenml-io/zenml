...
<Frame caption="Embarking on MLOps can be intricate. ZenML simplifies the journey.">
  <img src="/images/user-guide/Fabstractions_showcase.png" />
</Frame>

Throughout this guide, we'll cover essential topics including:

* [Creating your first ML pipeline](/versions/0.66.0/user-guide/starter-guide/create-an-ml-pipeline)
* [Understanding caching between pipeline steps](/versions/0.66.0/user-guide/starter-guide/cache-previous-executions)
* [Managing data and data versioning](/versions/0.66.0/user-guide/starter-guide/manage-artifacts)
* [Tracking your machine learning models](/versions/0.66.0/user-guide/starter-guide/track-ml-models)

Before jumping in, make sure you have a Python environment ready and `virtualenv` installed to follow along with ease. By the end, you will have completed a [starter project](/versions/0.66.0/user-guide/starter-guide/starter-project), marking the beginning of your journey into MLOps with ZenML.
