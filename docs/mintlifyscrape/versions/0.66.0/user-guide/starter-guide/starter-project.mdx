...
* [Pipelines and steps](/versions/0.66.0/user-guide/starter-guide/create-an-ml-pipeline)
* [Artifacts](/versions/0.66.0/user-guide/starter-guide/manage-artifacts)
* [Models](/versions/0.66.0/user-guide/starter-guide/track-ml-models)
...
We will then use [ZenML templates](/versions/0.66.0/how-to/setting-up-a-project-repository/using-project-templates) to help us get the code we need for the project:
...
This marks the end of the first chapter of your MLOps journey with ZenML. Make sure you do your own experimentation with ZenML to master the basics. When ready, move on to the [production guide](/versions/0.66.0/user-guide/production-guide), which is the next part of the series.
