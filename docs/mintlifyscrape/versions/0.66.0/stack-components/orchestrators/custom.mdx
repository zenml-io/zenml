...
Check out the [code sample](/versions/0.66.0/stack-components/orchestrators/custom#code-sample) below for more details on how to fetch the Docker image, command, arguments and step order.
