...
<Frame caption="Model Registries
">
  <img src="/images/stack-components/stack-components-38.avif"/>
</Frame>
...
| ------------------------------------------------------------------ | -------- | ----------- | ------------------------------------------ |
| [MLflow](/versions/0.66.0/stack-components/model-registries/mlflow)                | mlflow   | mlflow      | Add MLflow as Model Registry to your stack |
| [Custom Implementation](/versions/0.66.0/stack-components/model-registries/custom) | _custom_ | _custom_    |                                            |
