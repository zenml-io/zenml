...
The local image builder is an [image builder](/versions/0.66.0/stack-components/image-builders) flavor that comes built-in with ZenML and uses the local Docker installation on your client machine to build container images.
