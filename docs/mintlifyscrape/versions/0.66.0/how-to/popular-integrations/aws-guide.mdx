...
An [artifact store](/versions/0.66.0/user-guide/production-guide/remote-storage) is used for storing and versioning data flowing through your pipelines.
...
More details [here](/versions/0.66.0/stack-components/artifact-stores/s3).

### Orchestrator (SageMaker Pipelines)

An [orchestrator](/versions/0.66.0/user-guide/production-guide/cloud-orchestration) is the compute backend to run your pipelines.
...
More details [here](/versions/0.66.0/stack-components/orchestrators/sagemaker).

### Container Registry (ECR)

A [container registry](/versions/0.66.0/stack-components/container-registries) is used to store Docker images for your pipelines.
...
More details [here](/versions/0.66.0/stack-components/container-registries/aws).
...
<Frame caption="Sequence of events that happen when running a pipeline on a remote stack with a code repository">
  <img src="/images/how-to/stack-70.avif"/>
</Frame>
