...
* Using a YAML configuration file as described [here](/versions/0.66.0/how-to/use-configuration-files):
...
Check out [this page](/versions/0.66.0/how-to/use-configuration-files/configuration-hierarchy) for more information on the hierarchy and precedence of the various ways in which you can supply the settings.
