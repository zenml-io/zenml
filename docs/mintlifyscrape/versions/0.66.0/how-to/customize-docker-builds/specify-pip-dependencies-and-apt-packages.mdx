...
def my_pipeline(...):
    ...
```
* Specify a list of [ZenML integrations](/versions/0.66.0/stack-components/component-guide) that you're using in your pipeline:
