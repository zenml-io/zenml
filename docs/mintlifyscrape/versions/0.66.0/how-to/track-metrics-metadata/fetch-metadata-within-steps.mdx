...
Furthermore, you can also use the `StepContext` to find out where the outputs of your current step will be stored and which [Materializer](/versions/0.66.0/how-to/handle-data-artifacts/handle-custom-data-types) class will be used to save them:
