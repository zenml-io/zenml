...
<CardGroup>
<Card title="Limitations of Notebook Steps" icon="circle-exclamation" href="/versions/0.66.0/how-to/run-remote-steps-and-pipelines-from-notebooks/limitations-of-defining-steps-in-notebook-cells" horizontal/>
<Card title="Run Single Step from Notebook" icon="play" href="/versions/0.66.0/how-to/run-remote-steps-and-pipelines-from-notebooks/run-a-single-step-from-a-notebook" horizontal/>
</CardGroup>
