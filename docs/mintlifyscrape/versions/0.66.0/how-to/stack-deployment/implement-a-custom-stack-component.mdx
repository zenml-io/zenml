...
| ------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Orchestrator](/versions/0.66.0/stack-components/orchestrators/custom)              | Orchestrating the runs of your pipeline                           |
| [Artifact Store](/versions/0.66.0/stack-components/artifact-stores/custom)          | Storage for the artifacts created by your pipelines               |
| [Container Registry](/versions/0.66.0/stack-components/container-registries/custom) | Store for your containers                                         |
| [Step Operator](/versions/0.66.0/stack-components/step-operators/custom)            | Execution of individual steps in specialized runtime environments |
| [Model Deployer](/versions/0.66.0/stack-components/model-deployers/custom)          | Services/platforms responsible for online model serving           |
| [Feature Store](/versions/0.66.0/stack-components/feature-stores/custom)            | Management of your data/features                                  |
| [Experiment Tracker](/versions/0.66.0/stack-components/experiment-trackers/custom)  | Tracking your ML experiments                                      |
| [Alerter](/versions/0.66.0/stack-components/alerters/custom)                        | Sending alerts through specified channels                         |
| [Annotator](/versions/0.66.0/stack-components/annotators/custom)                    | Annotating and labeling data                                      |
| [Data Validator](/versions/0.66.0/stack-components/data-validators/custom)          | Validating and monitoring your data                               |
