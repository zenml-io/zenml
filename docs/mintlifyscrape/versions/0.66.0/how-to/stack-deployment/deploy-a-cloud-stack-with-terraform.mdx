...
If you prefer a more automated approach, you can use [the 1-click stack deployment feature](/versions/0.66.0/how-to/stack-deployment/deploy-a-cloud-stack) to deploy a cloud stack with ZenML with minimal knowledge of Terraform or cloud infrastructure for that matter.
