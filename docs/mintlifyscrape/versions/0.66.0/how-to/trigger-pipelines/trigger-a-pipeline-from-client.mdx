...
<CardGroup>
 <Card title="Run Pipeline from Another" icon="diagram-project" href="/versions/0.66.0/how-to/trigger-pipelines/trigger-a-pipeline-from-another" horizontal/> <Card title="Run Pipeline from REST API" icon="code" href="/versions/0.66.0/how-to/trigger-pipelines/trigger-a-pipeline-from-rest-api" horizontal/></CardGroup>
