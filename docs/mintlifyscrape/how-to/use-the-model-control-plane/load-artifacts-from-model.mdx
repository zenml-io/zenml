...
One of the more common use-cases for a Model is to pass artifacts between pipelines (a pattern we have seen [before](/how-to/use-the-model-control-plane/connecting-artifacts-via-a-model)). However, when and how to load these artifacts is important to know as well.
