...
Now that we've learned about managing [artifacts](/user-guide/starter-guide/manage-artifacts) and [models](/user-guide/starter-guide/track-ml-models), we can shift our attention again to the thing that brings them together: [Pipelines](/user-guide/starter-guide/create-an-ml-pipeline). This trifecta together will then inform how we structure our project.

In order to see the recommended repository structure of a ZenML MLOps project, read the [best practices](/how-to/setting-up-a-project-repository/best-practices) section.
...
![](/images/how-to/use-the-model-control-plane/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-19d869f106f7d37d63693897706abf91fcb3eba2%252Fartifact_exchange.png)

A simple artifact exchange between two pipelines

In this scenario, the [ZenML Client](/reference/python-client#client-methods) can be used to facilitate such an exchange:
...
![](/images/how-to/use-the-model-control-plane/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-90a30941fc416959e678b65fbd48aa4d0805c4f9%252Fmcp_pipeline_overview.png)
