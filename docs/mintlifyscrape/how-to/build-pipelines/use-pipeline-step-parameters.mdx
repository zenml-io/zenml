...
[Use configuration files to set parameters](/how-to/build-pipelines/use-pipeline-step-parameters)[How caching works and how to control it](/how-to/build-pipelines/control-caching-behavior)
