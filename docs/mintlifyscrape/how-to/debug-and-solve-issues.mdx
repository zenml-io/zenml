...
![](/images/how-to/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-10b2b35b50f030cbe3dbb072d4ef99d3b129243e%252Fslack_search_bar.png)  
Searching on Slack.
...
![](/images/how-to/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-0606c684113c2cd78d8fe3913c777fb13a5016b5%252Fdoc_search_bar.png)  
Searching on docs page.
* Check out the [common errors](/how-to/debug-and-solve-issues#most-common-errors) section below.
* Understand the problem by studying the [additional logs](/how-to/debug-and-solve-issues#41-additional-logs) and [client/server logs](/how-to/debug-and-solve-issues#client-and-server-logs).
...
NewConnectionError(': Failed to establish a new connection: [Errno 61] Connection refused'))
```
...
│ /home/dnth/Documents/zenml-projects/nba-pipeline/run_pipeline.py:24 in                   │
...
│ /home/dnth/Documents/zenml-projects/nba-pipeline/steps/trainer.py:24 in                  │
...
This also applies to all other [stack components](/stack-components/component-guide).
