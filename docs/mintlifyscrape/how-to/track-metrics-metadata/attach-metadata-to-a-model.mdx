...
Once metadata has been logged in an [artifact](/how-to/track-metrics-metadata/attach-metadata-to-an-artifact), model, or [step](/how-to/track-metrics-metadata/attach-metadata-to-steps), we can easily fetch the metadata with the ZenML Client:
