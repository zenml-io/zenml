...
Once metadata has been logged in an [artifact](/how-to/track-metrics-metadata/attach-metadata-to-an-artifact), [model](/how-to/track-metrics-metadata/attach-metadata-to-a-model), we can easily fetch the metadata with the ZenML Client:
