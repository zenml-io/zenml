...
You can see another example of using an `UnmaterializedArtifact` when triggering a [pipeline from another](/how-to/trigger-pipelines/trigger-a-pipeline-from-another).
