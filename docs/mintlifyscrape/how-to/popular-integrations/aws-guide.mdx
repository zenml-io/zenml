...
An [artifact store](/user-guide/production-guide/remote-storage) is used for storing and versioning data flowing through your pipelines.
...
An [orchestrator](/user-guide/production-guide/cloud-orchestration) is the compute backend to run your pipelines.
...
![](/images/how-to/popular-integrations/zenml%2Fblob%2Frelease%2F0.66.0%2Fdocs%2Fbook%2F.gitbook%2Fassets%2FCreate_Stack.png)
...
![](/images/how-to/popular-integrations/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-bce622fd61f1356f1622280b02cc8ea2b74b305c%252Frun_with_repository.png)

Sequence of events that happen when running a pipeline on a remote stack with a code repository

Read more in the [production guide](https://github.com/zenml-io/zenml/blob/release/0.66.0/docs/book/user-guide/production-guide/production-guide.md).
