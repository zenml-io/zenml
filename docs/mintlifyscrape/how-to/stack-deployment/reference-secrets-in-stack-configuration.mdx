---
title: "Reference secrets in stack configuration"
...
* [Interact with secrets](/how-to/interact-with-secrets): Learn how to create, list, and delete secrets using the ZenML CLI and Python SDK.
