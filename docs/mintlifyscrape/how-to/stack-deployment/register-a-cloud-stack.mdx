...
If you do not have the required infrastructure pieces already deployed on your cloud, you can also use [the 1-click deployment tool to build your cloud stack](/how-to/stack-deployment/deploy-a-cloud-stack).

Alternatively, if you prefer to have more control over where and how resources are provisioned in your cloud, you can [use one of our Terraform modules](/how-to/stack-deployment/deploy-a-cloud-stack-with-terraform) to manage your infrastructure as code yourself.
...
![](/images/how-to/stack-deployment/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-6866091ffd03245ba6513d18622fdbb2350aa22d%252Fstack-wizard-new-stack.png)

The new stacks page

Here you can click on "+ New Stack" and choose the option "Use existing Cloud".

![](/images/how-to/stack-deployment/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-1b005cbe53daf534cd0f55d22d484d3b6f463839%252Fstack-wizard-options.png)

New stack options

Next, you have to select the cloud provider that you want to work with.

![](/images/how-to/stack-deployment/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-ca7901bc280ff22aca135efd9da830e88540609b%252Fstack-wizard-cloud-selection.png)
...
![](/images/how-to/stack-deployment/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-0a8e10c53eada64344283525d5cb6e498847afc1%252Fstack-wizard-example.png)
...
![Wizard Example](/images/how-to/stack-deployment/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-e724b9e39634a1a2b589a7b1600b5946b2fe8bf3%252Fstack-wizard-aws-auth.png)
...
To register the cloud stack, the first thing that the wizard needs is a [service connector](/how-to/auth-management/service-connectors-guide). You can either use an existing connector by providing its ID or name `-sc <SERVICE_CONNECTOR_ID_OR_NAME>` (CLI-Only) or the wizard will create one for you.
