...
Currently, the [SlackAlerter](/stack-components/alerters/slack) and [DiscordAlerter](/stack-components/alerters/discord) are the available alerter integrations. However, it is straightforward to extend ZenML and [build an alerter for other chat services](/stack-components/alerters/custom).

| Alerter                                                    | Flavor   | Integration                                                        | Notes                            |
| ---------------------------------------------------------- | -------- | ------------------------------------------------------------------ | -------------------------------- |
| [Slack](/stack-components/alerters/slack)                  | slack    | slack                                                              | Interacts with a Slack channel   |
| [Discord](/stack-components/alerters/discord)              | discord  | discord                                                            | Interacts with a Discord channel |
| [Custom Implementation](/stack-components/alerters/custom) | _custom_ | Extend the alerter abstraction and provide your own implementation |                                  |
