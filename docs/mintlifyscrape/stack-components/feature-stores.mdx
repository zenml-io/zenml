...
| ---------------------------------------------------------------- | -------- | ------------------------------------------------------------------------ | ----------------------------------------- |
| [FeastFeatureStore](/stack-components/feature-stores/feast)      | feast    | feast                                                                    | Connect ZenML with already existing Feast |
| [Custom Implementation](/stack-components/feature-stores/custom) | _custom_ | Extend the feature store abstraction and provide your own implementation |                                           |
...
The available implementation of the feature store is built on top of the feast integration, which means that using a feature store is no different from what's described on the [feast page: How to use it?](/stack-components/feature-stores/feast#how-do-you-use-it).
