...
```
    zenml step-operator register  \
        ...
        --service_account= # optionally specify the service account to use for the VertexAI CustomJob

        --network= # optionally specify the network to use for the VertexAI CustomJob

        --reserved_ip_ranges= # optionally specify the reserved IP range to use for the VertexAI CustomJob
```
...
@step(step_operator=, settings={"step_operator": VertexStepOperatorSettings(
