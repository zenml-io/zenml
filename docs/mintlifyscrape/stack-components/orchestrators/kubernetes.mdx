...
* you're not willing to maintain [Kubeflow Pipelines](/stack-components/orchestrators/kubeflow) on your Kubernetes cluster.
* you're not interested in paying for managed solutions like [Vertex](/stack-components/orchestrators/vertex).
...
* A Kubernetes cluster [deployed](/stack-components/orchestrators/kubernetes#how-to-deploy-it)
...
Check out the [SDK docs](https://sdkdocs.zenml.io/latest/integration%5Fcode%5Fdocs/integrations-kubernetes/#zenml.integrations.kubernetes.flavors.kubernetes%5Forchestrator%5Fflavor.KubernetesOrchestratorSettings) for a full list of available attributes and [this docs page](/how-to/use-configuration-files/runtime-configuration) for more information on how to specify settings.
