...
![](/images/stack-components/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-3af32819ee7f82f8cbe6b58761a58af70ea8f528%252FRemote-with-model-registry.png)
...
| ------------------------------------------------------------------ | -------- | ----------- | ------------------------------------------ |
| [MLflow](/stack-components/model-registries/mlflow)                | mlflow   | mlflow      | Add MLflow as Model Registry to your stack |
| [Custom Implementation](/stack-components/model-registries/custom) | _custom_ | _custom_    |                                            |
