...
![](/images/user-guide/production-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-29deaf510c77fd8d9f172dfbc3c22b66e18aade5%252Fci-cd-overall.png)

Pipeline being run on staging/production stack through ci/cd
...
In order to facilitate machine-to-machine connection you need to create an API key within ZenML. Learn more about those [here](https://docs.zenml.io/how-to/connecting-to-zenml/connect-with-a-service-account).
...
![](/images/user-guide/production-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-a597f6de9b89604d523f187c8f3d1a52af8472c7%252Fcreate_gh_secret.png)

create\_gh\_secret.png
...
This step is optional, all you'll need for certain is a stack that runs remotely (remote orchestration and artifact storage). The rest is up to you. You might for example want to parametrize your pipeline to use different data sources for the respective environments. You can also use different [configuration files](https://github.com/zenml-io/zenml/blob/release/0.66.0/docs/book/how-to/configuring-zenml/configuring-zenml.md) for the different environments to configure the [Model](/how-to/use-the-model-control-plane), the [DockerSettings](/how-to/customize-docker-builds/docker-settings-on-a-pipeline), the [ResourceSettings like accelerators](/how-to/training-with-gpus) differently for the different environments.
...
![](/images/user-guide/production-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-cce96df22a720a5c4d450fa99af062dca3b9fd9c%252Fgithub-action-pr-comment.png)

Comment left on Pull Request
