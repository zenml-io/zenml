...
* The value of [deploying ZenML](/user-guide/production-guide/deploying-zenml)
* Abstracting infrastructure configuration into [stacks](/user-guide/production-guide/understand-stacks)
...
* [Connecting a git repository](/user-guide/production-guide/connect-code-repository)
...
The e2e project is a comprehensive project template to cover major use cases of ZenML: a collection of steps and pipelines and, to top it all off, a simple but useful CLI. It showcases the core ZenML concepts for supervised ML with batch predictions. It builds on top of the [starter project](/user-guide/starter-guide/starter-project) with more advanced concepts.

As you progress through the e2e batch template, try running the pipelines on a [remote cloud stack](/user-guide/production-guide/cloud-orchestration) on a tracked [git repository](/user-guide/production-guide/connect-code-repository) to practice some of the concepts we have learned in this guide.
