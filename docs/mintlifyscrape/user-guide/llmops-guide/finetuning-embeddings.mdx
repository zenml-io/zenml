---
title: "Improve retrieval by finetuning embeddings"
...
* [generating synthetic data with distilabel](/user-guide/llmops-guide/finetuning-embeddings/synthetic-data-generation)
...
* [evaluating finetuned embeddings and using ZenML's model control plane to get a systematic overview](/user-guide/llmops-guide/finetuning-embeddings/evaluating-finetuned-embeddings)
