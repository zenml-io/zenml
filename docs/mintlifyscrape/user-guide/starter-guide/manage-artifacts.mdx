...
![](/images/user-guide/starter-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-646b6b8aa99d1a223f2984e2cb23725b0a357a64%252Fdcp_walkthrough.gif)
...
![](/images/user-guide/starter-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-159ed1941642a0ce9d03a7c2e894406d9949ee37%252Fdcp_artifacts_list.png)
...
Since custom versions cannot be duplicated, the above step can only be run once successfully. To avoid altering your code frequently, consider using a [YAML config](/user-guide/production-guide/configure-pipeline) for artifact versioning.
...
![](/images/user-guide/starter-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-440f3a5aed556b449ab8f7fae80e83ba808458f3%252Fdcp_artifacts_versions_list.png)
...
It is also common to consume an artifact downstream after producing it in an upstream pipeline or step. As we have learned in the [previous section](/how-to/build-pipelines/fetching-pipelines#fetching-artifacts-directly), the `Client` can be used to fetch artifacts directly inside the pipeline code:
...
Calls of `Client` methods like `get_artifact_version` directly inside the pipeline code makes use of ZenML's [late materialization](/how-to/handle-data-artifacts/load-artifacts-into-memory) behind the scenes.
...
One of the most useful ways of interacting with artifacts in ZenML is the ability to associate metadata with them. [As mentioned before](/how-to/build-pipelines/fetching-pipelines#artifact-information), artifact metadata is an arbitrary dictionary of key-value pairs that are useful for understanding the nature of the data.
...
PythonOSS (Dashboard)Cloud (Dashboard)
...
![](/images/user-guide/starter-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-9143ff57505cce9fd81583a7319624436584d552%252Fdashboard_artifact_metadata.png)
...
![](/images/user-guide/starter-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-f1004f678aff9ce7b38638bcd6447303b8663aa6%252Fdcp_metadata.png)
...
![](/images/user-guide/starter-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-3d1a65bc95017295a44e609647cf1eb9680408a3%252Fartifact_management_1.png)

**Run 2:**

![](/images/user-guide/starter-guide/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FSXceRPgF1t4PqY7HbePb%252Fuploads%252Fgit-blob-29ac08892bc04c243896144d709e9753140c3418%252Fartifact_management_2.png)
