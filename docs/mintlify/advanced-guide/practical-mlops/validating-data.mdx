...
In the following, we will use the open-source data monitoring tool [Evidently](https://evidentlyai.com/) to measure distribution differences between our datasets. See this [blog post](https://blog.zenml.io/zenml-loves-evidently/) of ours that explains the Evidently integration in more detail.
...
zenml stack update  -dv evidently_validator
```

Other ways of validating our data include the use of the following integrations:

* Deepchecks ([example](https://github.com/zenml-io/zenml/tree/main/examples/deepchecks%5Fdata%5Fvalidation))

* Great Expectations ([example](https://github.com/zenml-io/zenml/tree/main/examples/great%5Fexpectations%5Fdata%5Fvalidation))

* Whylogs ([example](https://github.com/zenml-io/zenml/tree/main/examples/whylogs%5Fdata%5Fprofiling))

See the respective examples to get to know how they each work and what they can be used for.

To read a more detailed guide about how Data Validators function in ZenML, [click here](/component-gallery/data-validators).