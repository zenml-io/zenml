...
If your custom stack component flavor requires special setup before it can be used, check out the [Managing Stack Component States](/advanced-guide/stacks/stack-state-management) section for more details.
...
| ---------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [Orchestrator](/component-gallery/orchestrators/custom)              | Orchestrating the runs of your pipeline                           |
| [Artifact Store](/component-gallery/artifact-stores/custom)          | Storage for the artifacts created by your pipelines               |
| [Container Registry](/component-gallery/container-registries/custom) | Store for your containers                                         |
| [Secrets Manager](/component-gallery/secrets-managers/custom)        | Centralized location for the storage of your secrets              |
| [Step Operator](/component-gallery/step-operators/custom)            | Execution of individual steps in specialized runtime environments |
| [Model Deployer](/component-gallery/model-deployers/custom)          | Services/platforms responsible for online model serving           |
| [Feature Store](/component-gallery/feature-stores/custom)            | Management of your data/features                                  |
| [Experiment Tracker](/component-gallery/experiment-trackers/custom)  | Tracking your ML experiments                                      |
| [Alerter](/component-gallery/alerters/custom)                        | Sending alerts through specified channels                         |
| [Annotator](/component-gallery/annotators/custom)                    | Annotating and labeling data                                      |
| [Data Validator](/component-gallery/data-validators/custom)          | Validating and monitoring your data                               |