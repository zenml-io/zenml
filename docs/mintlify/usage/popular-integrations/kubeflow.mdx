...
1. Using a [Service Connector](/versions/0.66.0/how-to/auth-management/service-connectors-guide) to connect to the remote cluster (recommended for cloud-managed clusters). No local `kubectl` context needed.
...
For more advanced options and details, refer to the [full Kubeflow Orchestrator documentation](/versions/0.66.0/stack-components/orchestrators/kubeflow).
