...
```
<Info>
  Head on over to our [docs](/versions/0.66.0/stack-components/artifact-stores/gcp) to learn more about artifact stores and how to configure them.
</Info>
</Tab>
...
```
<Info>
 Head on over to our [docs](/versions/0.66.0/stack-components/orchestrators/vertex) to learn more about orchestrators and how to configure them.
</Info>
</Tab>
...
```
<Info>
Head on over to our [docs](/versions/0.66.0/stack-components/container-registries) to learn more about container registries and how to configure them.
</Info>
</Tab>
