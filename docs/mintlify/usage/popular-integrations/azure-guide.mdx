...
* ZenML [installed](/versions/0.66.0/getting-started/installation).
...
Once you have created the service principal and the client secret, you can go ahead and create [a ZenML Azure Service Connector](/versions/0.66.0/how-to/auth-management/azure-service-connector).
...
For more information regarding Azure Blob Storage artifact stores, feel free to [check the docs](/versions/0.66.0/stack-components/artifact-stores/azure).
...
For more information regarding AzureML orchestrator, feel free to [check the docs](/versions/0.66.0/stack-components/orchestrators/azureml).
...
For more information regarding Azure container registries, feel free to [check the docs](/versions/0.66.0/stack-components/container-registries/azure).
...
* Explore ZenML's [integrations](/versions/0.66.0/stack-components/component-guide) with other popular tools and frameworks in the machine learning ecosystem.
