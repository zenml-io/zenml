...
The [service connector](/usage/resource-data-management/auth-management) documentation goes deeper into the concept of service connectors and how they can be configured to give the server permission to access the artifact store. For a concrete example, see the [AWS S3](/stack-components/artifact-stores/s3) artifact store documentation.
