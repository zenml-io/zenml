...
Furthermore, you can also use the `StepContext` to find out where the outputs of your current step will be stored and which [Materializer](/usage/resource-data-management/handle-data-artifacts/handle-custom-data-types) class will be used to save them:
