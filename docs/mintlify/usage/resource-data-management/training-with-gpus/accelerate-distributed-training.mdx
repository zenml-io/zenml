...
## Use <Icon icon="face-smile-beam"/> Accelerate in your steps
...
For complete details, refer to the [containerization page](/usage/project-setup/customize-docker-builds). Here's an example using a CUDA-enabled PyTorch image:
