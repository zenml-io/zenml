...
You can see another example of using an `UnmaterializedArtifact` when triggering a [pipeline from another](/versions/0.66.0/how-to/trigger-pipelines/trigger-a-pipeline-from-another).
