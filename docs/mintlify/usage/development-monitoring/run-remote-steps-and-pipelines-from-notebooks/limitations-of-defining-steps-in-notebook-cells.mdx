...
description: "If you want to run ZenML steps defined in notebook cells remotely (either with a remote [orchestrator](/stack-components/orchestrators) or [step operator](/stack-components/step-operators)), the cells defining your steps must meet the following conditions"
icon: play
---
