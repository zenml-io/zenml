...
<Frame src="Searching on Slack.">
  <img src="/_assets/how-to/stack-82.avif"/>
</Frame>
...
<Frame src="Searching on docs page.">
  <img src="/_assets/how-to/stack-83.avif"/>
</Frame>

* Check out the [common errors](/usage/development-monitoring/debug-and-solve-issues#most-common-errors) section below.
* Understand the problem by studying the [additional logs](/usage/development-monitoring/debug-and-solve-issues#41-additional-logs) and [client/server logs](/usage/development-monitoring/debug-and-solve-issues#client-and-server-logs).
