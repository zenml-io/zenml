...
You can also use the [active model](/user-guide/guides/starter-guide/track-ml-models) to get the model metadata, or the associated artifacts directly as described in the [starter guide](/user-guide/guides/starter-guide/track-ml-models):
