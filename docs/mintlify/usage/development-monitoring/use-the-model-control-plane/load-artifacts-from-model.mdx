...
description: "One of the more common use-cases for a Model is to pass artifacts between pipelines (a pattern we have seen [before](/usage/development-monitoring/use-the-model-control-plane/connecting-artifacts-via-a-model))."
icon: spinner
---
