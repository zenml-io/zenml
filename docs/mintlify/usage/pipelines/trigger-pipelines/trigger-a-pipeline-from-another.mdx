...
Read more about Unmaterialized Artifacts [here](/usage/resource-data-management/handle-data-artifacts/unmaterialized-artifacts).

<CardGroup>
<Card title="Run Pipeline from Python Client" icon="python" href="/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-client" horizontal/> <Card title="Run Pipeline from REST API" icon="code" href="/usage/pipelines/trigger-pipelines/trigger-a-pipeline-from-rest-api" horizontal/> </CardGroup>
