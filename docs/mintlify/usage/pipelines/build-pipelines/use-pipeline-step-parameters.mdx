...
<CardGroup cols={2}>
<Card title="Use configuration files to set parameters" icon="gear" href="/usage/pipelines/build-pipelines/use-pipeline-step-parameters" horizontal />
<Card title="How caching works and how to control it" icon="database" href="/usage/pipelines/build-pipelines/control-caching-behavior" horizontal /> </CardGroup>
