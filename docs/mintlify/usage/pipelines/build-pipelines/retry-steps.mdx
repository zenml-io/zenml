...
<CardGroup cols={2}>
<Card title="Failure/Success Hooks" icon="basketball" href="/versions/0.66.0/how-to/build-pipelines/use-failure-success-hooks" horizontal />
<Card title="Configure Pipelines" icon="gear" href="/versions/0.66.0/how-to/use-configuration-files/how-to-use-config" horizontal />
</CardGroup>
