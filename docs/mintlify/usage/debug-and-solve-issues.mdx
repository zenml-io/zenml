...
<Frame src="Searching on Slack.">
  <img src="/images/how-to/stack-82.avif"/>
</Frame>
...
<Frame src="Searching on docs page.">
  <img src="/images/how-to/stack-83.avif"/>
</Frame>

* Check out the [common errors](/versions/0.66.0/how-to/debug-and-solve-issues#most-common-errors) section below.
* Understand the problem by studying the [additional logs](/versions/0.66.0/how-to/debug-and-solve-issues#41-additional-logs) and [client/server logs](/versions/0.66.0/how-to/debug-and-solve-issues#client-and-server-logs).
...
This also applies to all other [stack components](/versions/0.66.0/stack-components/component-guide).
