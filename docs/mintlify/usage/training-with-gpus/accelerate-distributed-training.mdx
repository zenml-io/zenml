...
For complete details, refer to the [containerization page](/versions/0.66.0/how-to/customize-docker-builds). Here's an example using a CUDA-enabled PyTorch image:
