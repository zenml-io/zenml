...
Now that we've learned about managing [artifacts](/versions/0.66.0/user-guide/starter-guide/manage-artifacts) and [models](/versions/0.66.0/user-guide/starter-guide/track-ml-models), we can shift our attention again to the thing that brings them together: [Pipelines](/versions/0.66.0/user-guide/starter-guide/create-an-ml-pipeline). This trifecta together will then inform how we structure our project.

<Info>
    In order to see the recommended repository structure of a ZenML MLOps project, read the [best practices](/versions/0.66.0/how-to/setting-up-a-project-repository/best-practices) section.
</Info>
...
">
  <img src="/images/how-to/stack-66.avif"/>
</Frame>


In this scenario, the [ZenML Client](versions/0.66.0/reference/python-client#client-methods) can be used to facilitate such an exchange:
