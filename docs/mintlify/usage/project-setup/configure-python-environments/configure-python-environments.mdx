...
See also [here](/usage/project-setup/configure-python-environments/configure-the-server-environment) for more on [configuring the server environment](/usage/project-setup/configure-python-environments/configure-the-server-environment).
