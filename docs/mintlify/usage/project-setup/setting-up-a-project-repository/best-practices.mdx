...
All ZenML [Project templates](/usage/project-setup/setting-up-a-project-repository/using-project-templates#generating-project-from-a-project-template) are modeled around this basic structure.
...
By default, ZenML uses the official [zenml Docker image](https://hub.docker.com/r/zenmldocker/zenml) as a base for all pipeline and step builds. You can use your own `Dockerfile` to overwrite this behavior. Learn more [here](/usage/project-setup/customize-docker-builds).
