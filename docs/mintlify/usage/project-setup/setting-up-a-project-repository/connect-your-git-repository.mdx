...
Code repositories enable ZenML to keep track of the code version that you use for your pipeline runs. Additionally, running a pipeline that is tracked in a registered code repository can [speed up the Docker image building for containerized stack components](/usage/project-setup/customize-docker-builds/use-code-repositories-to-speed-up-docker-build-times) by eliminating the need to rebuild Docker images each time you change one of your source code files.

Learn more about how code repositories benefit development [here](/usage/project-setup/customize-docker-builds/use-code-repositories-to-speed-up-docker-build-times).

## Registering a code repository

If you are planning to use one of the [available implementations of code repositories](/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository#available-implementations), first, you need to install the corresponding ZenML integration:
...
For concrete options, check out the section on the [GitHubCodeRepository](/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository#github), the [GitLabCodeRepository](/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository#gitlab) or how to develop and register a [custom code repository implementation](/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository#developing-a-custom-code-repository).

## Available implementations

ZenML comes with builtin implementations of the code repository abstraction for the `GitHub` and `GitLab` platforms, but it's also possible to use a [custom code repository implementation](/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository#developing-a-custom-code-repository).
