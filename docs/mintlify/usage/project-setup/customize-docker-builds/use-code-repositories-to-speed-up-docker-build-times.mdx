...
* First, the [source root](/versions/0.66.0/how-to/customize-docker-builds/which-files-are-built-into-the-image) is computed
...
* If you want to disable or enforce the downloading of files, check out [this docs page](/versions/0.66.0/how-to/customize-docker-builds/docker-settings-on-a-pipeline) for the available options.
