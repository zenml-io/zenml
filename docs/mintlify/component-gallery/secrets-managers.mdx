...
![](/images/component-gallery/Remote_with_secrets_manager.png)
...
| ------------------------------------------------------------------------ | -------- | ----------- | --------------- | -------------------------------------------------------------------------- |
| [Local](/component-gallery/secrets-managers/local)                     | local    | _built-in_  | No              | Uses local files to store secrets                                          |
| [AWS](/component-gallery/secrets-managers/aws)                         | aws      | aws         | Yes             | Uses AWS to store secrets                                                  |
| [GCP](/component-gallery/secrets-managers/gcp)                         | gcp      | gcp         | Yes             | Uses GCP to store secretes                                                 |
| [Azure](/component-gallery/secrets-managers/azure)                     | azure    | azure       | Yes             | Uses Azure Key Vaults to store secrets                                     |
| [GitHub](/component-gallery/secrets-managers/github)                   | github   | github      | No              | Uses GitHub to store secrets                                               |
| [HashiCorp Vault](/component-gallery/secrets-managers/hashicorp-vault) | vault    | vault       | Yes             | Uses HashiCorp Vault to store secrets                                      |
| [Custom Implementation](/component-gallery/secrets-managers/custom)    | _custom_ |            | No              | Extend the secrets manager abstraction and provide your own implementation |
...
A full guide on using the CLI interface to register, access, update and delete secrets is available [here](https://apidocs.zenml.io/latest/cli/#zenml.cli--using-secrets).
...
Secret references work with any secrets manager and allow you to securely specify sensitive configurations for your [stack components](/starter-guide/stacks/registering-stacks).

Check out the corresponding [documentation page](/advanced-guide/practical-mlops/secrets-management) for more information.

### Secret Scopes

Examples of situations in which Secrets Manager scoping can be useful:

* you want to control whether a secret configured in a Secrets Manager stack component is visible in another Secrets Manager stack component. This is useful when you want to share secrets without necessarily [sharing stack components](/starter-guide/collaborate).
...
![](/images/component-gallery/secret-scoping.png)
