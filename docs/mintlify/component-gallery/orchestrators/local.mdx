...
The local orchestrator is an [orchestrator](/component-gallery/orchestrators) flavor which comes built-in with ZenML and runs your pipelines locally.
...
For more information and a full list of configurable attributes of the local orchestrator, check out the [API Docs](https://apidocs.zenml.io/latest/core%5Fcode%5Fdocs/core-orchestrators/#zenml.orchestrators.local.local%5Forchestrator.LocalOrchestrator).