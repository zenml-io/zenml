...
If you are looking to deploy your models in a more complex way, you should use one of the other [Model Deployer Flavors](/component-gallery/model-deployers#model-deployers-flavors) available in ZenML (e.g. Seldon Core, KServe, etc.)
...
* [Model Deployer with MLflow](https://github.com/zenml-io/zenml/tree/main/examples/mlflow%5Fdeployment)

For more information and a full list of configurable attributes of the MLflow Model Deployer, check out the [API Docs](https://apidocs.zenml.io/latest/integration%5Fcode%5Fdocs/integrations-mlflow/#zenml.integrations.mlflow.model%5Fdeployers).