...
![](/images/component-gallery/annotation-when-where.png)
...
| -------------------------------------------------------------------- | ------------- | ------------- | -------------------------------------------------------------------- |
| [LabelStudioAnnotator](/component-gallery/annotators/label-studio) | label\_studio | label\_studio | Connect ZenML with Label Studio                                      |
| [Custom Implementation](/component-gallery/annotators/custom)      | _custom_      |              | Extend the annotator abstraction and provide your own implementation |
...
The available implementation of the annotator is built on top of the Label Studio integration, which means that using an annotator currently is no different from what's described in the [Label Studio page: How to use it?](/component-gallery/annotators/label-studio#how-do-you-use-it).
