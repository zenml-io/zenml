...
<Info>
  Learn how to get a bearer token for the curl commands [here](versions/0.66.0/reference/api-reference#using-a-bearer-token-to-access-the-api-programmatically).
</Info>
...
">
  <img src="/images/how-to/setting-up-a-project-repository/tp-1.png" />
</Frame>
...
">
  <img src="/images/how-to/setting-up-a-project-repository/tp-2.png" />
</Frame>
...
<CardGroup>
 <Card title="Run Pipeline from Another" icon="diagram-project" href="/versions/0.66.0/how-to/trigger-pipelines/trigger-a-pipeline-from-another" horizontal/> <Card title="Run Pipeline from Python Client" icon="python" href="/versions/0.66.0/how-to/trigger-pipelines/trigger-a-pipeline-from-client" horizontal/> </CardGroup>
