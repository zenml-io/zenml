...
![](/images/starter-guide/pipelines/zenml-dashboard.png)
...
For more details on other possible deployment options, see the [ZenML deployment documentation](/getting-started/deploying-zenml).
...
For full details, please refer to [the server deployment documentation](/getting-started/deploying-zenml).
...
![](/images/starter-guide/pipelines/zenml-dag-artifact-inspection.png)
