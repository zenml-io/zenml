...
<Info>
    If you would like to automatically track some metadata about your custom stack component with each pipeline run, you can do so by defining some additional methods in your stack component implementation class as shown in the [Tracking Custom Stack Component Metadata](/versions/0.66.0/how-to/track-metrics-metadata/fetch-metadata-within-steps) section.
</Info>
...
You can read more about the differences [here](/versions/0.66.0/how-to/use-configuration-files/runtime-configuration).
...
<Info>
    You can pass sensitive configuration values as [secrets](/versions/0.66.0/how-to/interact-with-secrets) by defining them as type `SecretField` in the configuration class.
</Info>
