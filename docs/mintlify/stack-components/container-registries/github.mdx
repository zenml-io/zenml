...
* you're using GitHub for your projects. If you're not using GitHub, take a look at the other [container registry flavors](/versions/0.66.0/stack-components/container-registries#container-registry-flavors).
...
* The registry URI. Check out the [previous section](/versions/0.66.0/stack-components/container-registries/github#how-to-find-the-registry-uri) on the URI format and how to get the URI for your registry.
