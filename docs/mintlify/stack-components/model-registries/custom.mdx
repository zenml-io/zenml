...
1. Learn more about the core concepts for the model registry [here](/versions/0.66.0/stack-components/model-registries#model-registry-concepts-and-terminology). Your custom model registry will be built on top of these concepts so it helps to be aware of them.
