...
* Data Validators used in ZenML pipelines usually generate data profiles and data quality check reports that are versioned and stored in the [Artifact Store](/stack-components/artifact-stores) and can be [retrieved and visualized](/versions/0.66.0/how-to/visualize-artifacts) later.
