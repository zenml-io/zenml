...
* [the AWS Service Connector](/versions/0.66.0/how-to/auth-management/aws-service-connector), if you are using an AWS EKS cluster.
* [the GCP Service Connector](/versions/0.66.0/how-to/auth-management/gcp-service-connector), if you are using a GKE cluster.
* [the Azure Service Connector](/versions/0.66.0/how-to/auth-management/azure-service-connector), if you are using an AKS cluster.
* [the generic Kubernetes Service Connector](/versions/0.66.0/how-to/auth-management/kubernetes-service-connector) for any other Kubernetes cluster.
