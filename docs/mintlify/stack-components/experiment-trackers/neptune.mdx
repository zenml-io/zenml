...
This method requires you to [configure a ZenML secret](/versions/0.66.0/how-to/interact-with-secrets) to store the Neptune tracking service credentials securely.
