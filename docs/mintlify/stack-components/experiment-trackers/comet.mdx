...
<Tabs>
    <Tab title="ZenML Secret (Recommended)">
        This method requires you to [configure a ZenML secret](/usage/project-setup/use-secrets/secret-management) to store the Comet tracking service credentials securely.
...
<Info>
    Read more about [ZenML Secrets](/usage/project-setup/use-secrets/secret-management) in the ZenML documentation.
</Info>
    </Tab>
...
<Info>
    Instead of hardcoding an experiment tracker name, you can also use the [Client](sdk/python-client) to dynamically use the experiment tracker of your active stack, as shown in the example above.
</Info>
