...
* the Experiment Tracker is an optional type of Stack Component that needs to be registered as part of your ZenML [Stack](/user-guide/guides/production-guide/understand-stacks).
