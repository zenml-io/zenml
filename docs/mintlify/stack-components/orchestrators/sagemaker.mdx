...
The recommended way to authenticate your SageMaker orchestrator is by registering an [AWS Service Connector](/usage/resource-data-management/auth-management/aws-service-connector) and connecting it to your SageMaker orchestrator:
...
<Info>
    ZenML will build a Docker image called `<CONTAINER_REGISTRY_URI>/zenml:<PIPELINE_NAME>` which includes your code and use it to run your pipeline steps in Sagemaker. Check out [this page](/usage/project-setup/customize-docker-builds) if you want to learn more about how ZenML builds these images and how you can customize them.
</Info>
...
Sagemaker Studio launch">
  <img src="/_assets/stack-components/stack-components-3.avif"/>
</Frame>
...
<Frame caption="Sagemaker Studio Pipelines">
  <img src="/_assets/stack-components/stack-components-4.avif"/>
</Frame>
...
<Frame caption="SageMaker Studio Logs">
  <img src="/_assets/stack-components/stack-components-5.avif"/>
</Frame>
...
<Frame caption="SageMaker CloudWatch Logs">
  <img src="/_assets/stack-components/stack-components-6.avif"/>
</Frame>
...
Check out [this docs page](/usage/project-setup/use-configuration-files/runtime-configuration) for more information on how to specify settings in general.
