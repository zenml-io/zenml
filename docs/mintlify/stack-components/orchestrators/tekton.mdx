...
* Tekton pipelines deployed on a remote cluster. See the [deployment section](/versions/0.66.0/stack-components/orchestrators/tekton#how-to-deploy-it) for more information.
