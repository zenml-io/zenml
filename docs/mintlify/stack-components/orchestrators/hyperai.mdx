...
[Scheduled pipelines](/usage/pipelines/build-pipelines/schedule-a-pipeline) are supported by the HyperAI orchestrator. Currently, the HyperAI orchestrator supports the following inputs to `Schedule`:
