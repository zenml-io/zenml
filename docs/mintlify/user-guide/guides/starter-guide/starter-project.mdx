...
* [Pipelines and steps](/user-guide/guides/starter-guide/create-an-ml-pipeline)
* [Artifacts](/user-guide/guides/starter-guide/manage-artifacts)
* [Models](/user-guide/guides/starter-guide/track-ml-models)
...
This marks the end of the first chapter of your MLOps journey with ZenML. Make sure you do your own experimentation with ZenML to master the basics. When ready, move on to the [production guide](/user-guide/guides/production-guide), which is the next part of the series.
