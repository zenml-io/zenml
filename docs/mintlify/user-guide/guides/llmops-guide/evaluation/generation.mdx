...
As with the [retrieval evaluation](/versions/0.66.0/user-guide/llmops-guide/evaluation/retrieval), we can start with a simple approach and then move on to more sophisticated methods.
