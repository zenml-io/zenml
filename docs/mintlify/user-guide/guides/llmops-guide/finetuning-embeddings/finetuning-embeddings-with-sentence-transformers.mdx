...
* load our data either from Hugging Face or [from Argilla via the ZenML annotation integration](/versions/0.66.0/stack-components/annotators/argilla)
...
This assumes that you've set up an Argilla annotator in your stack. The code checks for the annotator and downloads the data that was annotated in Argilla. Please see our [guide to using the Argilla integration with ZenML](/versions/0.66.0/stack-components/annotators/argilla) for more details.
