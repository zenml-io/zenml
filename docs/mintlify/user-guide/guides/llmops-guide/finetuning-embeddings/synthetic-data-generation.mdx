...
<Frame >
  <img src="/_assets/user-guide/sy-1.avif"/>
</Frame>
...
The [rest of the push\_to\_argilla step](https://github.com/zenml-io/zenml-projects/blob/main/llm-complete-guide/steps/push%5Fto%5Fargilla.py) is just setting up the Argilla dataset and pushing the data to it.
...
<Frame caption="Argilla interface for data annotation">
  <img src="/_assets/user-guide/sy-2.avif"/>
</Frame>
