...
Now that we have ZenML deployed, we can take the next steps in making sure that our machine learning workflows are production-ready. As you were running [your first pipelines](/user-guide/guides/starter-guide/create-an-ml-pipeline), you might have already noticed the term `stack` in the logs and on the dashboard.
...
Let's use the pipeline in our starter project from the [previous guide](/user-guide/guides/starter-guide/starter-project) to see it in action.
