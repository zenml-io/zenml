...
">
  <img src="/images/user-guide/production-guide/Frun_with_repository.png" />
</Frame>
...
<Frame caption="Sequence of events that happen when running a pipeline on a remote stack with a code repository
">
  <img src="/images/user-guide/production-guide/git-1.avif" />
</Frame>

4. We recommend selecting the specific repository and then giving `contents` read-only access.
<Frame>
  <img src="/images/user-guide/production-guide/Fgithub-token-set-permissions.png" />
</Frame>

<Frame >
  <img src="/images/user-guide/production-guide/git-3.avif" />
</Frame>

5. Click on "Generate token" and copy the token to a safe place.

<Frame >
  <img src="/images/user-guide/production-guide/git-4.avif" />
</Frame>
