...
We can now push our local code (from the [previous chapters](/user-guide/guides/production-guide/understand-stacks#run-a-pipeline-on-the-new-local-stack)) to GitHub with these commands:
