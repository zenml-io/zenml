...
While ZenML supports [many different flavors of git repositories](/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository), this guide will focus on [GitHub](https://github.com). To create a repository on GitHub:
...
You can read more about [the ZenML Git Integration here](/usage/project-setup/setting-up-a-project-repository/connect-your-git-repository).
