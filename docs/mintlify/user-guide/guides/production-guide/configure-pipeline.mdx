...
<Info>
Read more about settings in ZenML [here](/usage/project-setup/use-configuration-files/runtime-configuration) and [here](/versions/0.66.0/how-to/training-with-gpus)
</Info>
...
Bear in mind that not every orchestrator supports `ResourceSettings` directly. To learn more, you can read about [ResourceSettings here](/usage/project-setup/use-configuration-files/runtime-configuration), including the ability to [attach a GPU](/versions/0.66.0/how-to/training-with-gpus#1-specify-a-cuda-enabled-parent-image-in-your-dockersettings).
