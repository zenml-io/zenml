...
<Info>
  Having trouble connecting with a browser? There are other ways to connect. Read [here](/usage/resource-data-management/connecting-to-zenml) for more details.
</Info>
