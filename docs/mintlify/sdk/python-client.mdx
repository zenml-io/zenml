...
* **Code Repositories**: The git code repositories that you have connected with your ZenML instance. See [here](/user-guide/guides/production-guide/connect-code-repository) for more information.
...
* **Flavors**: The [stack component flavors](/versions/0.66.0/getting-started/core-concepts#flavor) available to you, including:
   * Built-in flavors like the [local orchestrator](/stack-components/orchestrators/local),
   * Integration-enabled flavors like the [Kubeflow orchestrator](/stack-components/orchestrators/kubeflow),
