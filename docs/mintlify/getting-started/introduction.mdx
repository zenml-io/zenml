...
<CardGroup cols={3}>
 <Card title="Switch to production" icon="building" href="/user-guide/production-guide/cloud-orchestration">
...
<Card title="Starter Guide" icon="egg" href="/user-guide/starter-guide">
