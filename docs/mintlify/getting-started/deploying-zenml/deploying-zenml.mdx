...
2. **Self-hosted Deployment:** Alternatively, you have the ability to deploy ZenML on your own self-hosted environment. This can be achieved through various methods, including using [our CLI](/versions/0.66.0/getting-started/deploying-zenml/deploy-with-zenml-cli), [Docker](/stack-components/model-registries), [Helm](/versions/0.66.0/getting-started/deploying-zenml/deploy-with-helm), or [HuggingFace Spaces](/versions/0.66.0/getting-started/deploying-zenml/deploy-using-huggingface-spaces). We also offer our Pro version for self-hosted deployments, so you can use our full paid feature-set while staying fully in control with an airgapped solution on your infrastructure.
