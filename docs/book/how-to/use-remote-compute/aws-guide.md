...
A [container registry](../component-guide/container-registries/) is used to store Docker images for your pipelines.
...
* Explore ZenML's [integrations](../component-guide/integration-overview.md) with other popular tools and frameworks in the machine learning ecosystem.
