...
*   Specify a requirements file:
    ...
    def my_pipeline(...):
        ...
    ```
* Specify a list of [ZenML integrations](https://github.com/zenml-io/zenml/blob/feature/gro-1047-docs/docs/book/component-guide/README.md) that you're using in your pipeline:
