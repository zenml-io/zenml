...
ZenML automatically [builds and pushes Docker images](../configure-python-environments/#execution-environments) when running a pipeline on a stack requiring Docker images. To run this build step separately without running the pipeline, call:
