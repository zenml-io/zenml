...
[Image builders](../../configure-stack-components/image-builders/) determine how and where an image is built. Learn more [here](../configure-python-environments/#image-builder-environment).
