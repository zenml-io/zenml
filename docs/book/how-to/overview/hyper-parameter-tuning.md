...
_To setup the local environment used below, follow the recommendations from the_ [_Project templates_](../../user-guide/production-guide/best-practices/using-project-templates.md#advanced-guide)_._
...
_To setup the local environment used below, follow the recommendations from the_ [_Project templates_](../../user-guide/production-guide/best-practices/using-project-templates.md)_._
