...
Furthermore, you can also use the `StepContext` to find out where the outputs of your current step will be stored and which [Materializer](../../user-guide/advanced-guide/data-management/handle-custom-data-types.md) class will be used to save them:
