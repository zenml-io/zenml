...
Once metadata has been logged in an [artifact](attach-metadata-to-steps.md#logging-metadata-for-artifacts), [model](attach-metadata-to-steps.md#logging-metadata-for-models), or [step](attach-metadata-to-steps.md#logging-metadata-for-steps), we can easily fetch the metadata with the ZenML Client:
