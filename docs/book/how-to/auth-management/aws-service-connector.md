...
The [S3 Artifact Store Stack Component](../../stacks-and-components/component-guide/artifact-stores/s3.md) can be connected to a remote AWS S3 bucket through an AWS Service Connector.
...
* a [Kubernetes Orchestrator](../../stacks-and-components/component-guide/orchestrators/kubernetes.md) connected to an EKS Kubernetes cluster
* an [S3 Artifact Store](../../stacks-and-components/component-guide/artifact-stores/s3.md) connected to an S3 bucket
* an [ECR Container Registry](../../stacks-and-components/component-guide/container-registries/aws.md) stack component connected to an ECR container registry
