...
* a [Kubernetes Orchestrator](../configure-stack-components/orchestrators/kubernetes.md) connected to an AKS Kubernetes cluster
* a [Azure Blob Storage Artifact Store](../configure-stack-components/artifact-stores/azure.md) connected to an Azure blob storage container
* an [Azure Container Registry](../configure-stack-components/container-registries/azure.md) connected to an ACR container registry
