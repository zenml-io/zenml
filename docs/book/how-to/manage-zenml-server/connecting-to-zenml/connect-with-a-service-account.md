...
Accessing the API with this method is thoroughly documented in the [API reference section](https://docs.zenml.io/reference/api-reference#using-a-service-account-and-an-api-key).
