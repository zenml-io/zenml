...
- **Python Version**: Make sure that the Python version you are using is compatible with the ZenML version you are upgrading to. Check out the [installation guide](/docs/book/getting-started/installation.md) to find out which Python version is supported.
