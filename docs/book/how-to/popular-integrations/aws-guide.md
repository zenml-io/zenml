...
A [container registry](https://github.com/zenml-io/zenml/blob/feature/gro-1047-docs/docs/book/how-to/component-guide/container-registries/README.md) is used to store Docker images for your pipelines.
