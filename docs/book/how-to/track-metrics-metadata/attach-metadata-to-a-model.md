...
Once metadata has been logged in an [artifact](../handle-data-artifacts/attach-metadata-to-a-artifact.md), model, or [step](attach-metadata-to-steps.md), we can easily fetch the metadata with the ZenML Client:
