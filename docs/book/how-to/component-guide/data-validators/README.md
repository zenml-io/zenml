...
* you can access the data validation artifacts in subsequent pipeline steps, or [fetch them afterwards](../../../how-to/inspecting-pipelines-models-artifacts/fetching-pipelines.md) to process them or visualize them as needed.
