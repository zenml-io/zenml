...
* [retrieve pipeline artifacts](../../../how-to/inspecting-pipelines-models-artifacts/fetching-pipelines.md) from the active Artifact Store after a pipeline run is complete.
