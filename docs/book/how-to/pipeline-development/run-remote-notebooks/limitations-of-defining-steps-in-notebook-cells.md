...
If you want to run ZenML steps defined in notebook cells remotely (either with a remote [orchestrator](https://docs.zenml.io/stacks/orchestrators/orchestrators) or [step operator](https://docs.zenml.io/stacks/step-operators/step-operators)), the cells defining your steps must meet the following conditions:
