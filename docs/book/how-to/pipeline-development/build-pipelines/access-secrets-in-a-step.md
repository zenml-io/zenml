...
the [platform guide on secrets](https://docs.zenml.io/getting-started/deploying-zenml/secret-management).
...
<table data-view="cards">
    ...
    <tr>
        ...
        <td></td>
        <td></td>
        <td><a href="https://docs.zenml.io/how-to/interact-with-secrets">interact-with-secrets.md</a></td>
    </tr>
    <tr>
        <td>Find out more about the secrets backend in ZenML</td>
        <td></td>
        <td></td>
        <td><a href="https://docs.zenml.io/getting-started/deploying-zenml/secret-management">secret-management.md</a></td>
    </tr>
    </tbody>
</table>
