...
When you register the Azure Artifact Store, you can create a [ZenML Secret](../../getting-started/deploying-zenml/zenml-self-hosted/manage-the-deployed-services/secret-management.md) to store a variety of Azure credentials and then reference it in the Artifact Store configuration:
