...
deployed to a public cloud cluster. We will start with some pre-requisites and 
...
go for a serverless alternative to Kubeflow, check out our example on how to
