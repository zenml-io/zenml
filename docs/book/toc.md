...
* [Running in Production](./advanced-guide/production/production.md)
  * [Stack Recipes](./advanced-guide/production/stack-recipes.md)
  * [Switching orchestration](./advanced-guide/production/switching-orchestration.md)
  * [Secrets Management](./advanced-guide/production/secrets-management.md)
  * [Containerization (Docker)](./advanced-guide/production/containerization.md)
  * [Tracking experiments](./advanced-guide/production/tracking-experiments.md)
  * [Validating data](./advanced-guide/production/validating-data.md)
  * [Deploying models and batch inference](./advanced-guide/production/deploying-models.md)
* [Pipelines](./advanced-guide/pipelines/pipelines.md)
  ...
  * [Pass custom data types through steps (Materializers)](./advanced-guide/pipelines/pipelines.md)
