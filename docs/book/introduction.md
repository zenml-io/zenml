...
The platform has two entry points. Pick the one that matches your work — they share the same server, stacks, and dashboard, so you can adopt the other later without starting over.

<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>ML Pipelines</strong></td><td>Build, version, and deploy classical ML and LLM pipelines with ZenML.</td><td><a href="getting-started/hello-world.md">hello-world.md</a></td></tr><tr><td><strong>AI Agents</strong></td><td>Make agent workflows durable, replayable, and observable with Kitaru — ZenML's durable execution layer for agents.</td><td><a href="https://docs.zenml.io/kitaru">https://docs.zenml.io/kitaru</a></td></tr></tbody></table>
