...
Check out [our dedicated documentation page](../user-guide/production-guide/best-practices/handling-dependencies.md) on some ways you can try to solve these dependency and versioning issues.
