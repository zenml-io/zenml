...
Check out [this page](../../user-guide/advanced-guide/pipelining-features/managing-steps.md#type-annotations) for more information on how to annotate your step outputs.
