...
implementation of the [Materializer](../../../../old_book/advanced-guide/pipelines/materializers.md)
...
your own [Materializer](../../../../old_book/advanced-guide/pipelines/materializers.md) to 
...
part of your ZenML [Stack](../../../../old_book/starter-guide/stacks/stacks.md).
* the objects circulated through your pipelines are serialized and stored in the
Artifact Store using [Materializers](../../../../old_book/advanced-guide/pipelines/materializers.md).
...
Store using [the post-execution workflow API](../../../../old_book/starter-guide/pipelines/pipelines.md).
...
* use [the post-execution workflow API](../../../../old_book/starter-guide/pipelines/pipelines.md)
...
* if you implement custom [Materializers](../../../../old_book/advanced-guide/pipelines/materializers.md)
...
[Materializers](../../../../old_book/advanced-guide/pipelines/materializers.md) for an 
example).
{% endhint %}
