...
even just work on multiple machines. While you can always zip up or check into
version control the yaml based store files, a more live option is to spin up
