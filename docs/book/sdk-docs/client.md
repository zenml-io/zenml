...
* [`Client.active_stack_model`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client.active_stack_model)
...
* [`Client.config_directory`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client.config_directory)
...
* [`Client.zen_store`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client.zen_store)
* [`Client.__init__`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client.__init__)
* [`Client._config_path`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._config_path)
* [`Client._delete_artifact_from_artifact_store`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._delete_artifact_from_artifact_store)
* [`Client._delete_artifact_version`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._delete_artifact_version)
* [`Client._get_entity_by_id_or_name_or_prefix`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._get_entity_by_id_or_name_or_prefix)
* [`Client._get_entity_by_prefix`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._get_entity_by_prefix)
* [`Client._load_config`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._load_config)
* [`Client._reset_instance`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._reset_instance)
* [`Client._sanitize_config`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._sanitize_config)
* [`Client._set_active_root`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._set_active_root)
* [`Client._validate_code_repository_config`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._validate_code_repository_config)
* [`Client._validate_stack_configuration`](https://sdkdocs.zenml.io/latest/core_code_docs/core-client.html#zenml.client.Client._validate_stack_configuration)
