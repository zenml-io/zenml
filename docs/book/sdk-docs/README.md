...
* **Kitaru** — ZenML's durable execution layer for AI agents (flows, checkpoints, replay, wait), published at [sdkdocs.kitaru.ai](https://sdkdocs.kitaru.ai).
...
[Kitaru](https://docs.zenml.io/kitaru) is ZenML's durable execution layer for AI agents. Its Python SDK and CLI reference are generated from the Kitaru source and published on a dedicated site.
