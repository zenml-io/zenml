...
* **Kitaru** — ZenML's sibling project for recording, replaying, and improving AI agents: real executions get recorded, then replayed against your real code with one thing changed (flows, checkpoints, replay, wait), published at [sdkdocs.kitaru.ai](https://sdkdocs.kitaru.ai).
...
[Kitaru](https://docs.zenml.io/kitaru) is ZenML's sibling project for recording, replaying, and improving AI agents — real executions become a test bed you replay against your real code. Its Python SDK and CLI reference are generated from the Kitaru source and published on a dedicated site.
