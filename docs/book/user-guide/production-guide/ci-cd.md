...
![Pipeline being run on staging/production stack through ci/cd](https://github.com/zenml-io/zenml/blob/feature/gro-1047-docs/docs/book/.gitbook/assets/ci-cd-overall.png)
...
![Pipeline with local stack](https://github.com/zenml-io/zenml/blob/feature/gro-1047-docs/docs/book/.gitbook/assets/ci-cd-local.png)
...
![Pipeline with staging stack](https://github.com/zenml-io/zenml/blob/feature/gro-1047-docs/docs/book/.gitbook/assets/ci-cd-staging.png)
...
![Pipeline with production stack](https://github.com/zenml-io/zenml/blob/feature/gro-1047-docs/docs/book/.gitbook/assets/ci-cd-prod.png)
