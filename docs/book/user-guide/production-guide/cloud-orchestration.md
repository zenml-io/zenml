...
* The [orchestrator](../../how-to/component-guide/orchestrators/) manages the workflow and execution of your pipelines.
* The [container registry](../../how-to/component-guide/container-registries/) is a storage and content delivery system that holds your Docker container images.
...
While there are detailed docs on [how to set up a Skypilot orchestrator](../../how-to/component-guide/orchestrators/skypilot-vm.md) and a [container registry](../../how-to/component-guide/container-registries/) on each public cloud, we have put the most relevant details here for convenience:
...
Once the service connector is set up, we can register [a Skypilot orchestrator](../../how-to/component-guide/orchestrators/skypilot-vm.md):
...
The next step is to register [an AWS container registry](../../how-to/component-guide/container-registries/aws.md). Similar to the orchestrator, we will use our connector as we are setting up the container registry:
...
For more information, you can always check the [dedicated Skypilot orchestrator guide](../../how-to/component-guide/orchestrators/skypilot-vm.md).
{% endtab %}
...
The next step is to register [a GCP container registry](../../how-to/component-guide/container-registries/gcp.md). Similar to the orchestrator, we will use our connector as we are setting up the container registry:
...
The next step is to register [an Azure container registry](../../how-to/component-guide/container-registries/azure.md). Similar to the orchestrator, we will use our connector as we are setting up the container registry.
...
Curious to see what other stacks you can create? The [Component Guide](../../how-to/component-guide/) has an exhaustive list of various artifact stores, container registries, and orchestrators that are integrated with ZenML. Try playing around with more stack components to see how easy it is to switch between MLOps stacks with ZenML.
