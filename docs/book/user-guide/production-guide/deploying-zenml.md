...
{% hint style="info" %}
Having trouble connecting with a browser? There are other way's to connect. Read [here](../advanced-guide/configuring-zenml/connecting-to-zenml.md) for more details.
{% endhint %}
