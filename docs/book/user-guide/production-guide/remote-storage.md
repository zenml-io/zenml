...
Out of the box, ZenML ships with [many different supported artifact store flavors](../../how-to/configure-stack-components/artifact-stores/). For convenience, here are some brief instructions on how to quickly get up and running on the major cloud providers:
...
The Amazon Web Services S3 Artifact Store flavor is provided by the [S3 ZenML integration](../../how-to/configure-stack-components/artifact-stores/s3.md), you need to install it on your local machine to be able to register an S3 Artifact Store and add it to your stack:
...
For more information, read the [dedicated S3 artifact store flavor guide](../../how-to/configure-stack-components/artifact-stores/s3.md).
{% endtab %}
...
The Google Cloud Storage Artifact Store flavor is provided by the [GCP ZenML integration](../../how-to/configure-stack-components/artifact-stores/gcp.md), you need to install it on your local machine to be able to register a GCS Artifact Store and add it to your stack:
...
For more information, read the [dedicated GCS artifact store flavor guide](../../how-to/configure-stack-components/artifact-stores/gcp.md).
{% endtab %}
...
The Microsoft Azure Artifact Store flavor is provided by the [Azure ZenML integration](../../how-to/configure-stack-components/artifact-stores/azure.md), you need to install it on your local machine to be able to register an Azure Artifact Store and add it to your stack:
...
For more information, read the [dedicated Azure artifact store flavor guide](../../how-to/configure-stack-components/artifact-stores/azure.md).
{% endtab %}

{% tab title="Other" %}
You can create a remote artifact store in pretty much any environment, including other cloud providers using a cloud-agnostic artifact storage such as [Minio](../../how-to/configure-stack-components/artifact-stores/).
