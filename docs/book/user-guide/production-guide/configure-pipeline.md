...
Bear in mind that not every orchestrator supports `ResourceSettings` directly. To learn more, you can read about [`ResourceSettings` here](../../how-to/overview/scale-compute-to-the-cloud.md), including the ability to [attach a GPU](../../how-to/overview/scale-compute-to-the-cloud.md#1-specify-a-cuda-enabled-parent-image-in-your-dockersettings).
