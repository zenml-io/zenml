...
This method requires you to [configure a ZenML secret](../../../platform-guide/set-up-your-mlops-platform/use-the-secret-store/use-the-secret-store.md) to store the Neptune tracking service credentials securely.
