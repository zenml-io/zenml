...
You don't need to directly interact with any ZenML step operator in your code. As long as the step operator that you want to use is part of your active [ZenML stack](../../starter-guide/understand-stacks.md), you can simply specify it in the `@step` decorator of your step.
...
If some of your steps require additional hardware resources, you can specify them on your steps as described [here](../../advanced-guide/configure-steps-pipelines.md).
