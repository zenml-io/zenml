...
{% hint style="warning" %}
If you're going to use a remote deployment of Airflow, you'll also need a [remote ZenML deployment](../../../platform-guide/set-up-your-mlops-platform/deploy-zenml/deploy-zenml.md).
{% endhint %}
...
* A remote ZenML server deployed to the cloud. See the [deployment guide](../../../platform-guide/set-up-your-mlops-platform/deploy-zenml/deploy-zenml.md) for more information.
...
Check out our docs on how to apply settings to your pipelines [here](../../advanced-guide/configure-steps-pipelines.md).
