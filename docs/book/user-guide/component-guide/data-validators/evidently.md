...
Alternatively, if you are running inside a Jupyter notebook, you can load and render the reports using [post-execution artifact visualization](../../starter-guide/fetch-runs-after-execution.md#visualizing-artifacts), e.g.:
...
![Evidently metrics report visualization](../../../../../examples/evidently\_data\_validation/assets/evidently-metrics-report.png)

![Evidently test results visualization](../../../../../examples/evidently\_data\_validation/assets/evidently-test-results.png)
