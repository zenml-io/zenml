...
Alternatively, if you are running inside a Jupyter notebook, you can load and render the whylogs profiles using post-execution artifact visualization, e.g.:
...
![Whylogs Visualization Example 1](../../../assets/whylogs/whylogs-visualizer-01.png) ![Whylogs Visualization Example 2](../../../assets/whylogs/whylogs-visualizer-02.png)
