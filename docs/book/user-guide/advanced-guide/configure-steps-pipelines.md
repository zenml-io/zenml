...
![Scenario 3: Deployed ZenML Server](../../.gitbook/assets/zenml_step_logs.png)

If you do not want to store the logs in your artifact store, you can disable this behaviour by using the `enable_step_logs` parameter either with your `@pipeline` or `@step` decorator:
