...
![ZenML Artifact Visualizations](/docs/book/.gitbook/assets/artifact_visualization_dashboard.png)
...
![CSV Visualization Example](/docs/book/.gitbook/assets/artifact_visualization_csv.png)
