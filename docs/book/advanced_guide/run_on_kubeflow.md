...
orchestrator built for machine learning workflows. When developing ML models, you probably develop your pipelines on 
...
You can watch a tutorial video of a Kubeflow stack based example [here](https://www.youtube.com/watch?v=b5TXRYkdL3w).

Or you can also check out our  example of this 
...
If you don't want to manually set thing up, feel free to run it with this command.
```shell
...
A [Stack](../introduction/core-concepts.md) is the configuration of the surrounding infrastructure where ZenML pipelines
...
When you did `zenml init` at the start of this guide, a default `local_stack` was created with local version of all of
...
ZenML will help with all of these and above -> Watch out for future releases and the next extension of this guide coming
soon!
