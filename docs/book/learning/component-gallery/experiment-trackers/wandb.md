...
This method requires you to [configure a ZenML secret](../../../../old\_book/starter-guide/production-fundamentals/secrets-management.md) to store the Weights & Biases tracking service credentials securely.
