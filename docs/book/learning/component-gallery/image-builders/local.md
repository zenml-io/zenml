...
The local image builder is an [image builder](image-builders.md) flavor which comes built-in with ZenML and uses the local Docker installation on your client machine to build container images.
