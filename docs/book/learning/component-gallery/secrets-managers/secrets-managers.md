...
Secret references work with any secrets manager and allow you to securely specify sensitive configurations for your [stack components](../../../../old\_book/starter-guide/stacks/registering-stacks.md).

Check out the corresponding [documentation page](../../../../old\_book/starter-guide/production-fundamentals/secrets-management.md) for more information.

### Secret Scopes

Examples of situations in which Secrets Manager scoping can be useful:

* you want to control whether a secret configured in a Secrets Manager stack component is visible in another Secrets Manager stack component. This is useful when you want to share secrets without necessarily [sharing stack components](../../../../old\_book/starter-guide/stacks/sharing-stacks.md).
