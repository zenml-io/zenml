...
* [retrieve pipeline artifacts](https://github.com/zenml-io/zenml/blob/feature/gro-1047-docs/docs/user-guide/starter-guide/fetching-pipelines.md) from the active Artifact Store after a pipeline run is complete.
