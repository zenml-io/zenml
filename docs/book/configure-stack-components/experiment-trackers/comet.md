...
You should consider one of the other [Experiment Tracker flavors](../experiment-trackers/README.md#experiment-tracker-flavors) if you have never worked with Comet before and would rather use another experiment tracking tool that you are more familiar with.
