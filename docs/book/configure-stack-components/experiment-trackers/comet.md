...
This method requires you to [configure a ZenML secret](../../user-guide/advanced-guide/secret-management/secret-management.md) to store the Comet tracking service credentials securely.
...
{% hint style="info" %}
Read more about [ZenML Secrets](../../user-guide/advanced-guide/secret-management/secret-management.md) in the ZenML documentation.
{% endhint %}
{% endtab %}
{% endtabs %}
