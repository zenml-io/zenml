...
{% hint style="info" %}
If you would like to automatically track some metadata about your custom stack component with each pipeline run, you can do so by defining some additional methods in your stack component implementation class as shown in the [Tracking Custom Stack Component Metadata](../pipelining-features/fetch-metadata-within-steps.md) section.
{% endhint %}
...
You can read more about the differences [here](../../user-guide/production-guide/pipeline-settings.md).
{% endhint %}
...
{% hint style="info" %}
You can pass sensitive configuration values as [secrets](../secret-management/secret-management.md) by defining them as type `SecretField` in the configuration class.
{% endhint %}
