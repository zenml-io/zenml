...
Each category selected above would correspond to a [stack component type](../../../stacks-and-components/component-guide.md). You can now start developing individual stack component flavors for this type by following the detailed instructions on the respective pages.
