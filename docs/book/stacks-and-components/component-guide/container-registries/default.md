...
The Default container registry is a [container registry](./README.md) flavor that comes built-in with ZenML and allows container registry URIs of any format.
