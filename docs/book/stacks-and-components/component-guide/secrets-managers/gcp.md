...
cloud, [configure your ZenML server to connect to and use the GCP Secrets Manager service](/docs/book/deploying-zenml/zenml-self-hosted/zenml-self-hosted.md)
