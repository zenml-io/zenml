...
When you register the Azure Artifact Store, you can create a [ZenML Secret](../../../how-to/configuring-zenml/secret-management.md) to store a variety of Azure credentials and then reference it in the Artifact Store configuration:
