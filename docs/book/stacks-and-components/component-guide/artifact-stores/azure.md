...
![Azure Service Connector Type](../../../.gitbook/assets/azure-service-connector-type.png) ![Azure Blob Storage Service Connector Configuration](../../../.gitbook/assets/azure-blob-service-connector-configuration.png)
...
When you register the Azure Artifact Store, you can create a [ZenML Secret](../../../user-guide/advanced-guide/secret-management/) to store a variety of Azure credentials and then reference it in the Artifact Store configuration:
