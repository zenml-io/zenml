...
When you register the S3 Artifact Store, you can [generate an AWS access key](https://aws.amazon.com/premiumsupport/knowledge-center/create-access-key/), store it in a [ZenML Secret](../../../user-guide/advanced-guide/configuring-zenml/secret-management.md) and then reference it in the Artifact Store configuration.
