...
This method requires you to [configure a ZenML secret](../../../user-guide/advanced-guide/secret-management/) to store the Weights & Biases tracking service credentials securely.
