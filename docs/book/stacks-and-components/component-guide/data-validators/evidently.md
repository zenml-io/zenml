...
Alternatively, if you are running inside a Jupyter notebook, you can load and render the reports using the [artifact.visualize() method](../../../user-guide/starter-guide/fetch-runs-after-execution.md#artifact-visualizations), e.g.:
...
![Evidently metrics report visualization](<../../../.gitbook/assets/evidently-metrics-report (1).png>)

![Evidently test results visualization](<../../../.gitbook/assets/evidently-test-results (1).png>)
