...
Alternatively, if you are running inside a Jupyter notebook, you can load and render the reports using the [artifact.visualize() method](../../../user-guide/advanced-guide/data-management/visualize-artifacts.md), e.g.:
