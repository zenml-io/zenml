...
* In case the [parent image](../../../how-to/containerize-your-pipeline/#using-a-custom-parent-image) you use in your `DockerSettings` is stored in a private registry, the pod needs to be authenticated to pull from this registry.
