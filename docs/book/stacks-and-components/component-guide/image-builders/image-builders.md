...
| [GCPImageBuilder](broken-reference) | `gcp`    | `gcp`       | Builds your Docker images using Google Cloud Build.                      |
...
You don't need to directly interact with any image builder in your code. As long as the image builder that you want to use is part of your active [ZenML stack](../../../user-guide/starter-guide/understand-stacks.md), it will be used automatically by any component that needs to build container images.
