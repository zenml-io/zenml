...
You can [schedule pipeline runs](https://github.com/zenml-io/zenml/blob/release/0.45.4/docs/book/stacks-and-components/advanced-guide/pipelining-features/schedule-pipeline-runs.md) on Airflow similarly to other orchestrators. However, note that **Airflow schedules always need to be set in the past**, e.g.,:
...
Check out our docs on how to apply settings to your pipelines [here](../../../user-guide/advanced-guide/pipelining-features/configure-steps-pipelines.md).
