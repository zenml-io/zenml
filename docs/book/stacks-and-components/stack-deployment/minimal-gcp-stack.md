...
{% hint style="info" %}
Head on over to our [docs](https://github.com/zenml-io/zenml/blob/release/0.45.4/docs/book/stacks-and-components/component-guide/artifact-stores/gcp/README.md) to learn more about artifact stores and how to configure them.
{% endhint %}
{% endtab %}
