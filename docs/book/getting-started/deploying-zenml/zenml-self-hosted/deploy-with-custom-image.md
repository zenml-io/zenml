...
* You have implemented a custom artifact store for which you want to enable [artifact visualizations](../../../how-to/visualize-artifacts/README.md) or [step logs](../../../how-to/control-logging/README.md) in your dashboard.
