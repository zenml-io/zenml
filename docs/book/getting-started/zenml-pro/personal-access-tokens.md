---
description: Learn how to manage and use Personal Access Tokens.
icon: user-lock
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/0X0jeOmA9V2fzR9bl1bS/access-management/personal-access-tokens
---
...
![Personal Access Tokens](<.gitbook/assets/pro-personal-access-tokens-01 (1).png>)
...
* **Use Service Accounts for CI/CD**: For automated workflows and CI/CD pipelines, use [service accounts](service-accounts.md) instead of PATs. This follows the principle of least privilege by granting only necessary permissions rather than your full user permissions.
