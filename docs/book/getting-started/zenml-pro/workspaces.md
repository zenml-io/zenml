...
* [Create snapshots out of your pipeline runs](../../how-to/snapshots/snapshots.md#using-the-dashboard)
* [Run snapshots from the Dashboard](../../how-to/snapshots/snapshots.md#using-the-dashboard-1)
