...
* [Create snapshots out of your pipeline runs](https://docs.zenml.io/how-to/snapshots#using-the-dashboard)
* [Run snapshots from the Dashboard](https://docs.zenml.io/how-to/snapshots#using-the-dashboard-1)
