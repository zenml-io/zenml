...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/0X0jeOmA9V2fzR9bl1bS/core-concepts/teams
---
...
![Create Team](<.gitbook/assets/create_team (1).png>)
{% endstep %}
...
![Add Team Members](<.gitbook/assets/add_team_members (1).png>)
{% endstep %}
{% endstepper %}
...
![Assign Team to Workspace](<.gitbook/assets/assign_team_to_tenant (1).png>)
{% endstep %}
{% endstepper %}
...
![Team Roles](<.gitbook/assets/team_roles (1).png>)
