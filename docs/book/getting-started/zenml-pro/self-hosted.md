...
* later on, when you're running containerized pipelines with ZenML, you'll also want to inject those same CA certificates into the container images built by ZenML by customizing the build process via [DockerSettings](../../how-to/customize-docker-builds/README.md). Remember to set the `REQUESTS_CA_BUNDLE` environment variable just as you do for your local machine.
