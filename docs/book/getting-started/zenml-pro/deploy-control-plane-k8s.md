...
To deploy and enroll a workspace, you can use the process covered in the [Deploying Workspaces](deploy-workspace-k8s.md) sections. Make sure to use the ZenML Pro control plane URLs you used for the self-hosted deployment:
