...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/0X0jeOmA9V2fzR9bl1bS/core-concepts/organization
---
...
![Image showing invite flow](<.gitbook/assets/add_org_members (1).png>)
...
![Image showing the organization settings page](<.gitbook/assets/org_settings (1).png>)
...
![Image showing the Swagger docs](<.gitbook/assets/cloudapi_swagger (1).png>)
