...
{% hint style="warning" %}
Note that ZenML currently supports **Python 3.7, 3.8, 3.9, and 3.10**. Please make sure that you are using a supported Python version.
{% endhint %}

## Install with the dashboard

ZenML comes bundled with a web dashboard that lives inside a [sister repository](https://github.com/zenml-io/zenml-dashboard). In order to get access to the dashboard **locally**, you need to launch the [ZenML Server and Dashboard locally](../platform-guide/set-up-your-mlops-platform/deploy-zenml/deploy-zenml.md). For this, you need to install the optional dependencies for the ZenML Server:
