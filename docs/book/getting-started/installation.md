...
For the deployment of ZenML, you have the option to either [self-host](why-deploy-zenml/zenml-self-hosted/) it or register for a free [ZenML Pro](https://cloud.zenml.io/?utm\_source=docs\&utm\_medium=referral\_link\&utm\_campaign=cloud\_promotion\&utm\_content=signup\_link) server.
