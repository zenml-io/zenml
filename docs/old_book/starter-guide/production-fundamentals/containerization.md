...
* Specify a pip requirements file:
    ...
    def my_pipeline(...):
        ...
    ```
* Specify a list of [ZenML integrations](../../../book/learning/component-gallery/integrations.md) that you're using in your pipeline:
    ```python
...
The [image builder](../../../book/learning/component-gallery/image-builders/image-builders.md) component
...
(when using the [local image builder](../../../book/learning/component-gallery/image-builders/local.md))
