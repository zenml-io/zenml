...
- Orchestrate your ML workflows with [Kubeflow](../../../book/platform-guide/component-gallery/orchestrators/kubeflow.md),
- Save ML artifacts in an [Amazon S3](../../../book/platform-guide/component-gallery/artifact-stores/s3.md) bucket,
- Track your experiments with [Weights & Biases](../../../book/platform-guide/component-gallery/experiment-trackers/wandb.md),
- Deploy models on Kubernetes with [Seldon](../../../book/platform-guide/component-gallery/model-deployers/seldon.md) or [KServe](../../../book/platform-guide/component-gallery/model-deployers/kserve.md),
...
- A [Local Orchestrator](../../../book/platform-guide/component-gallery/orchestrators/local.md),
- A [Local Artifact Store](../../../book/platform-guide/component-gallery/artifact-stores/local.md),
...
grouped into [categories](../../../book/platform-guide/component-gallery/categories.md).
...
{% hint style="info" %}
Check out the [Categories of MLOps Tools](../../../book/platform-guide/component-gallery/categories.md)
page for a detailed overview of available stack components in ZenML.
{% endhint %}

### Orchestrator

The [Orchestrator](../../../book/platform-guide/component-gallery/orchestrators/orchestrators.md) is the 
component that defines how and where each pipeline step is executed when
calling `pipeline.run()`. By [default](../../../book/platform-guide/component-gallery/orchestrators/local.md),
...
[Kubeflow](../../../book/platform-guide/component-gallery/orchestrators/kubeflow.md) instead.

### Artifact Stores

Under the hood, all the artifacts in our ML pipeline are automatically stored
in an [Artifact Store](../../../book/platform-guide/component-gallery/artifact-stores/artifact-stores.md).
By [default](../../../book/platform-guide/component-gallery/artifact-stores/local.md), this is simply a
place in your local file system, but we could also configure ZenML to store
this data in a cloud bucket like [Amazon S3](../../../book/platform-guide/component-gallery/artifact-stores/s3.md) 
or any other place instead.

You can see all supported stack component types in a single table view [here](../../../book/platform-guide/component-gallery/categories.md)
...
[Integrations](../../../book/platform-guide/component-gallery/integrations.md).
