...
def create_agnostic_config(feature_spec,
                           label_keys=None,
                           prediction_keys=None):
    return ma_eval.model_agnostic_predict.ModelAgnosticConfig(
        feature_spec=feature_spec,
        label_keys=label_keys or ['tips'],
        prediction_keys=prediction_keys or ['trip_seconds'])
...
#
#
# def build_agnostic_config(slices=None,
#                           metrics=None,
#                           use_defaults=False):
#     if slices is None:
#         slices = list()
...
#
#     # MODEL SPEC
#     metric_labels = sorted(list(set(metrics.keys())))
#
#     model_specs = [tfma.ModelSpec(label_key='tips',
#                                   prediction_key='trip_seconds')]
#
#     # METRIC SPEC
#     baseline = [tfma.MetricConfig(class_name='ExampleCount')]
#     metrics_specs = []
